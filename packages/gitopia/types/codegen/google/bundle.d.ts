...
export declare namespace google {
    const api: {
        ...
        HttpRule: {
            ...
            fromJSON(object: any): _138.HttpRule;
        ...
        CustomHttpPattern: {
            ...
            fromJSON(object: any): _138.CustomHttpPattern;
    ...
    const protobuf: {
        ...
        Timestamp: {
            typeUrl: string;
            encode(message: _139.Timestamp, writer?: import("..").BinaryWriter): import("..").BinaryWriter;
            fromJSON(object: any): _139.Timestamp;
            fromPartial(object: Partial<_139.Timestamp>): _139.Timestamp;
            fromAmino(object: string): _139.Timestamp;
            toAmino(message: _139.Timestamp): string;
            fromAminoMsg(object: _139.TimestampAminoMsg): _139.Timestamp;
            fromProtoMsg(message: _139.TimestampProtoMsg): _139.Timestamp;
            toProto(message: _139.Timestamp): Uint8Array;
            toProtoMsg(message: _139.Timestamp): _139.TimestampProtoMsg;
        };
    };
}
