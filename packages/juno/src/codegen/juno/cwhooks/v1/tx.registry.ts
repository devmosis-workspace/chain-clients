...
export const MessageComposer = {
  ...
  fromJSON: {
    ...
    registerStaking(value: any) {
      return {
        typeUrl: "/juno.cwhooks.v1.MsgRegisterStaking",
        value: MsgRegisterStaking.fromJSON(value)
      };
    },
    unregisterStaking(value: any) {
      return {
        typeUrl: "/juno.cwhooks.v1.MsgUnregisterStaking",
        value: MsgUnregisterStaking.fromJSON(value)
      };
    },
    registerGovernance(value: any) {
      return {
        typeUrl: "/juno.cwhooks.v1.MsgRegisterGovernance",
        value: MsgRegisterGovernance.fromJSON(value)
      };
    },
    unregisterGovernance(value: any) {
      return {
        typeUrl: "/juno.cwhooks.v1.MsgUnregisterGovernance",
        value: MsgUnregisterGovernance.fromJSON(value)
      };
    }
  },
  fromPartial: {
