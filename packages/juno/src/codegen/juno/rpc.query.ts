...
export const createRPCQueryClient = async ({
  ...
  return {
    juno: {
      ...
      cwhooks: {
        v1: (await import("./cwhooks/v1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      drip: {
        v1: (await import("./drip/v1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      feepay: {
        v1: (await import("./feepay/v1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      feeshare: {
