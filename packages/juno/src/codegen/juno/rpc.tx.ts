...
export const createRPCMsgClient = async ({
  ...
  juno: {
    ...
    cwhooks: {
      v1: new (await import("./cwhooks/v1/tx.rpc.msg")).MsgClientImpl(rpc)
    },
    drip: {
      v1: new (await import("./drip/v1/tx.rpc.msg")).MsgClientImpl(rpc)
    },
    feepay: {
      v1: new (await import("./feepay/v1/tx.rpc.msg")).MsgClientImpl(rpc)
    },
    feeshare: {
