...
export const createLCDClient = async ({
  ...
  return {
    juno: {
      ...
      cwhooks: {
        v1: new (await import("./cwhooks/v1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      drip: {
        v1: new (await import("./drip/v1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      feepay: {
        v1: new (await import("./feepay/v1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      feeshare: {
