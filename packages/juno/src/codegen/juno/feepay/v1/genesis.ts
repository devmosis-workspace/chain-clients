...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      feePayContracts: Array.isArray(object?.feePayContracts) ? object.feePayContracts.map((e: any) => FeePayContract.fromJSON(e)) : []
    };
  },
...
export const Params = {
  ...
  fromJSON(object: any): Params {
    return {
      enableFeepay: isSet(object.enableFeepay) ? Boolean(object.enableFeepay) : false
    };
  },
