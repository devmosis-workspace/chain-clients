...
export const publicawesomeProtoRegistry: ReadonlyArray<[string, GeneratedType]> = [...stargazeAllocV1beta1TxRegistry.registry, ...stargazeClaimV1beta1TxRegistry.registry, ...stargazeGlobalfeeV1TxRegistry.registry];
