...
export interface Proposal {
  ...
  content?: (TextProposal & PromoteToPrivilegedContractProposal & DemotePrivilegedContractProposal & SetCodeAuthorizationProposal & RemoveCodeAuthorizationProposal & SetContractAuthorizationProposal & RemoveContractAuthorizationProposal & CommunityPoolSpendProposal & CommunityPoolSpendProposalWithDeposit & ParameterChangeProposal & SoftwareUpgradeProposal & CancelSoftwareUpgradeProposal & StoreCodeProposal & InstantiateContractProposal & InstantiateContract2Proposal & MigrateContractProposal & SudoContractProposal & ExecuteContractProposal & UpdateAdminProposal & ClearAdminProposal & PinCodesProposal & UnpinCodesProposal & UpdateInstantiateConfigProposal & StoreAndInstantiateContractProposal & Any) | undefined;
...
export type ProposalEncoded = Omit<Proposal, "content"> & {
  /** content is the proposal's content. */content?: TextProposalProtoMsg | PromoteToPrivilegedContractProposalProtoMsg | DemotePrivilegedContractProposalProtoMsg | SetCodeAuthorizationProposalProtoMsg | RemoveCodeAuthorizationProposalProtoMsg | SetContractAuthorizationProposalProtoMsg | RemoveContractAuthorizationProposalProtoMsg | CommunityPoolSpendProposalProtoMsg | CommunityPoolSpendProposalWithDepositProtoMsg | ParameterChangeProposalProtoMsg | SoftwareUpgradeProposalProtoMsg | CancelSoftwareUpgradeProposalProtoMsg | StoreCodeProposalProtoMsg | InstantiateContractProposalProtoMsg | InstantiateContract2ProposalProtoMsg | MigrateContractProposalProtoMsg | SudoContractProposalProtoMsg | ExecuteContractProposalProtoMsg | UpdateAdminProposalProtoMsg | ClearAdminProposalProtoMsg | PinCodesProposalProtoMsg | UnpinCodesProposalProtoMsg | UpdateInstantiateConfigProposalProtoMsg | StoreAndInstantiateContractProposalProtoMsg | AnyProtoMsg | undefined;
};
/** Proposal defines the core field members of a governance proposal. */
...
export const Cosmos_govv1beta1Content_FromAmino = (content: AnyAmino): Any => {
  switch (content.type) {
    case "cron/PromoteToPrivilegedContractProposal":
    ...
    case "cron/DemotePrivilegedContractProposal":
      return Any.fromPartial({
    ...
    case "globalfee/SetCodeAuthorizationProposal":
      return Any.fromPartial({
    ...
    case "globalfee/RemoveCodeAuthorizationProposal":
      return Any.fromPartial({
    ...
    case "globalfee/SetContractAuthorizationProposal":
      return Any.fromPartial({
    ...
    case "globalfee/RemoveContractAuthorizationProposal":
      return Any.fromPartial({
  ...
  switch (content.typeUrl) {
    case "/publicawesome.stargaze.cron.v1.PromoteToPrivilegedContractProposal":
      return {
        ...
        value: PromoteToPrivilegedContractProposal.toAmino(PromoteToPrivilegedContractProposal.decode(content.value, undefined))
      };
    case "/publicawesome.stargaze.cron.v1.DemotePrivilegedContractProposal":
      return {
        type: "cron/DemotePrivilegedContractProposal",
        value: DemotePrivilegedContractProposal.toAmino(DemotePrivilegedContractProposal.decode(content.value, undefined))
      };
    case "/publicawesome.stargaze.globalfee.v1.SetCodeAuthorizationProposal":
      return {
        type: "globalfee/SetCodeAuthorizationProposal",
        value: SetCodeAuthorizationProposal.toAmino(SetCodeAuthorizationProposal.decode(content.value, undefined))
      };
    case "/publicawesome.stargaze.globalfee.v1.RemoveCodeAuthorizationProposal":
      return {
        type: "globalfee/RemoveCodeAuthorizationProposal",
        value: RemoveCodeAuthorizationProposal.toAmino(RemoveCodeAuthorizationProposal.decode(content.value, undefined))
      };
    case "/publicawesome.stargaze.globalfee.v1.SetContractAuthorizationProposal":
      return {
        type: "globalfee/SetContractAuthorizationProposal",
        value: SetContractAuthorizationProposal.toAmino(SetContractAuthorizationProposal.decode(content.value, undefined))
      };
    case "/publicawesome.stargaze.globalfee.v1.RemoveContractAuthorizationProposal":
      return {
        type: "globalfee/RemoveContractAuthorizationProposal",
        value: RemoveContractAuthorizationProposal.toAmino(RemoveContractAuthorizationProposal.decode(content.value, undefined))
      };
    case "/cosmos.distribution.v1beta1.CommunityPoolSpendProposal":
      return {
