...
import * as _170 from "./protobuf/timestamp";
import * as _171 from "./protobuf/descriptor";
import * as _172 from "./protobuf/any";
import * as _173 from "./protobuf/duration";
export declare namespace google {
    const api: {
        Http: {
            typeUrl: string;
            encode(message: _169.Http, writer?: import("..").BinaryWriter): import("..").BinaryWriter;
            fromJSON(object: any): _169.Http;
            fromPartial(object: Partial<_169.Http>): _169.Http;
            fromAmino(object: _169.HttpAmino): _169.Http;
            toAmino(message: _169.Http): _169.HttpAmino;
            fromAminoMsg(object: _169.HttpAminoMsg): _169.Http;
            fromProtoMsg(message: _169.HttpProtoMsg): _169.Http;
            toProto(message: _169.Http): Uint8Array;
            toProtoMsg(message: _169.Http): _169.HttpProtoMsg;
        };
        HttpRule: {
            typeUrl: string;
            encode(message: _169.HttpRule, writer?: import("..").BinaryWriter): import("..").BinaryWriter;
            fromJSON(object: any): _169.HttpRule;
            fromPartial(object: Partial<_169.HttpRule>): _169.HttpRule;
            fromAmino(object: _169.HttpRuleAmino): _169.HttpRule;
            toAmino(message: _169.HttpRule): _169.HttpRuleAmino;
            fromAminoMsg(object: _169.HttpRuleAminoMsg): _169.HttpRule;
            fromProtoMsg(message: _169.HttpRuleProtoMsg): _169.HttpRule;
            toProto(message: _169.HttpRule): Uint8Array;
            toProtoMsg(message: _169.HttpRule): _169.HttpRuleProtoMsg;
        };
        CustomHttpPattern: {
            typeUrl: string;
            encode(message: _169.CustomHttpPattern, writer?: import("..").BinaryWriter): import("..").BinaryWriter;
            fromJSON(object: any): _169.CustomHttpPattern;
            fromPartial(object: Partial<_169.CustomHttpPattern>): _169.CustomHttpPattern;
            fromAmino(object: _169.CustomHttpPatternAmino): _169.CustomHttpPattern;
            toAmino(message: _169.CustomHttpPattern): _169.CustomHttpPatternAmino;
            fromAminoMsg(object: _169.CustomHttpPatternAminoMsg): _169.CustomHttpPattern;
            fromProtoMsg(message: _169.CustomHttpPatternProtoMsg): _169.CustomHttpPattern;
            toProto(message: _169.CustomHttpPattern): Uint8Array;
            toProtoMsg(message: _169.CustomHttpPattern): _169.CustomHttpPatternProtoMsg;
        };
    };
    const protobuf: {
        Duration: {
            typeUrl: string;
            encode(message: _173.Duration, writer?: import("..").BinaryWriter): import("..").BinaryWriter;
            fromJSON(object: any): _173.Duration;
            fromPartial(object: Partial<_173.Duration>): _173.Duration;
            fromAmino(object: string): _173.Duration;
            toAmino(message: _173.Duration): string;
            fromAminoMsg(object: _173.DurationAminoMsg): _173.Duration;
            fromProtoMsg(message: _173.DurationProtoMsg): _173.Duration;
            toProto(message: _173.Duration): Uint8Array;
            toProtoMsg(message: _173.Duration): _173.DurationProtoMsg;
        };
        Any: {
            typeUrl: string;
        ...
        Timestamp: {
            typeUrl: string;
            encode(message: _170.Timestamp, writer?: import("..").BinaryWriter): import("..").BinaryWriter;
            fromJSON(object: any): _170.Timestamp;
            fromPartial(object: Partial<_170.Timestamp>): _170.Timestamp;
            fromAmino(object: string): _170.Timestamp;
            toAmino(message: _170.Timestamp): string;
            fromAminoMsg(object: _170.TimestampAminoMsg): _170.Timestamp;
            fromProtoMsg(message: _170.TimestampProtoMsg): _170.Timestamp;
            toProto(message: _170.Timestamp): Uint8Array;
            toProtoMsg(message: _170.Timestamp): _170.TimestampProtoMsg;
        };
    };
}
