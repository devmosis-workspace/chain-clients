...
export const Minter = {
  ...
  fromAmino(object: MinterAmino): Minter {
    ...
    if (object.last_update !== undefined && object.last_update !== null) {
      message.lastUpdate = Timestamp.fromAmino(object.last_update);
    }
    if (object.inflation_base !== undefined && object.inflation_base !== null) {
      message.inflationBase = object.inflation_base;
    }
    return message;
  },
  toAmino(message: Minter): MinterAmino {
    const obj: any = {};
    obj.last_update = message.lastUpdate ? Timestamp.toAmino(message.lastUpdate) : undefined;
