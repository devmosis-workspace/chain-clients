...
export const AminoConverter = {
  ...
  "/osmosis.lockup.MsgSetRewardReceiverAddress": {
    ...
    toAmino: ({
      ...
      lockID,
      rewardReceiver
    }: MsgSetRewardReceiverAddress): MsgSetRewardReceiverAddressAminoType["value"] => {
      return {
        owner,
    ...
    fromAmino: ({
      ...
      lockID,
      reward_receiver
    }: MsgSetRewardReceiverAddressAminoType["value"]): MsgSetRewardReceiverAddress => {
      return {
        owner,
        lockID: Long.fromString(lockID),
        rewardReceiver: reward_receiver
      };
    }
  }
};