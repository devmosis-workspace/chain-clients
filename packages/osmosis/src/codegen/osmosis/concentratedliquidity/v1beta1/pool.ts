...
export const Pool = {
  ...
  fromAmino(object: PoolAmino): Pool {
    ...
    if (object.last_liquidity_update !== undefined && object.last_liquidity_update !== null) {
      message.lastLiquidityUpdate = Timestamp.fromAmino(object.last_liquidity_update);
    }
    return message;
  },
  toAmino(message: Pool): PoolAmino {
    ...
    obj.last_liquidity_update = message.lastLiquidityUpdate ? Timestamp.toAmino(message.lastLiquidityUpdate) : undefined;
    return obj;
  },
