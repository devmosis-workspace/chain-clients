...
export declare const AminoConverter: {
    ...
    "/osmosis.valsetpref.v1beta1.MsgUndelegateFromRebalancedValidatorSet": {
        aminoType: string;
        toAmino: (message: MsgUndelegateFromRebalancedValidatorSet) => import("./tx").MsgUndelegateFromRebalancedValidatorSetAmino;
        fromAmino: (object: import("./tx").MsgUndelegateFromRebalancedValidatorSetAmino) => MsgUndelegateFromRebalancedValidatorSet;
    };
