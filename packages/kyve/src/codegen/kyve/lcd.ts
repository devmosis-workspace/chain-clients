...
export const createLCDClient = async ({
  ...
  return {
    kyve: {
      bundles: {
        v1beta1: new (await import("./bundles/v1beta1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      delegation: {
        v1beta1: new (await import("./delegation/v1beta1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      funders: {
        v1beta1: new (await import("./funders/v1beta1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      global: {
        v1beta1: new (await import("./global/v1beta1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      pool: {
        v1beta1: new (await import("./pool/v1beta1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      stakers: {
        v1beta1: new (await import("./stakers/v1beta1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      team: {
        v1beta1: new (await import("./team/v1beta1/query.lcd")).LCDQueryClient({
          requestClient
        })
      }
    },
