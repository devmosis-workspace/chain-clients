...
export const createRPCMsgClient = async ({
  ...
  kyve: {
    bundles: {
      v1beta1: new (await import("./bundles/v1beta1/tx.rpc.msg")).MsgClientImpl(rpc)
    },
    delegation: {
      v1beta1: new (await import("./delegation/v1beta1/tx.rpc.msg")).MsgClientImpl(rpc)
    },
    funders: {
      v1beta1: new (await import("./funders/v1beta1/tx.rpc.msg")).MsgClientImpl(rpc)
    },
    global: {
      v1beta1: new (await import("./global/v1beta1/tx.rpc.msg")).MsgClientImpl(rpc)
    },
    pool: {
      v1beta1: new (await import("./pool/v1beta1/tx.rpc.msg")).MsgClientImpl(rpc)
    },
    stakers: {
      v1beta1: new (await import("./stakers/v1beta1/tx.rpc.msg")).MsgClientImpl(rpc)
    },
    team: {
      v1beta1: new (await import("./team/v1beta1/tx.rpc.msg")).MsgClientImpl(rpc)
    }
  },
  cosmos: {
    auth: {
