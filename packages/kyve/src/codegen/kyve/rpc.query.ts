...
export const createRPCQueryClient = async ({
  ...
  return {
    kyve: {
      bundles: {
        v1beta1: (await import("./bundles/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      delegation: {
        v1beta1: (await import("./delegation/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      funders: {
        v1beta1: (await import("./funders/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      global: {
        v1beta1: (await import("./global/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      pool: {
        v1beta1: (await import("./pool/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      stakers: {
        v1beta1: (await import("./stakers/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      team: {
        v1beta1: (await import("./team/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
      }
    },
    cosmos: {
      app: {
