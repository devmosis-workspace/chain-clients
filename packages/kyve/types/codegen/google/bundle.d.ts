...
import * as _153 from "./protobuf/timestamp";
import * as _154 from "./protobuf/duration";
export declare namespace google {
    const api: {};
    const protobuf: {
        Duration: {
            encode(message: _154.Duration, writer?: import("protobufjs").Writer): import("protobufjs").Writer;
            fromJSON(object: any): _154.Duration;
            fromPartial(object: Partial<_154.Duration>): _154.Duration;
        };
        Timestamp: {
            encode(message: _153.Timestamp, writer?: import("protobufjs").Writer): import("protobufjs").Writer;
            fromJSON(object: any): _153.Timestamp;
            fromPartial(object: Partial<_153.Timestamp>): _153.Timestamp;
        };
        ...
        Any: {
            encode(message: _151.Any, writer?: import("protobufjs").Writer): import("protobufjs").Writer;
            fromJSON(object: any): _151.Any;
