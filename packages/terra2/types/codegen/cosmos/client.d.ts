...
export declare const cosmosAminoConverters: {
    ...
    "/cosmos.vesting.v1beta1.MsgDonateAllVestingTokens": {
        aminoType: string;
        toAmino: (message: import("./vesting/v1beta1/tx").MsgDonateAllVestingTokens) => import("./vesting/v1beta1/tx").MsgDonateAllVestingTokensAmino;
        fromAmino: (object: import("./vesting/v1beta1/tx").MsgDonateAllVestingTokensAmino) => import("./vesting/v1beta1/tx").MsgDonateAllVestingTokens;
    };
