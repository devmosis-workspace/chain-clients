...
export interface MsgDonateAllVestingTokensAminoType extends AminoMsg {
...
export declare const AminoConverter: {
    ...
    "/cosmos.vesting.v1beta1.MsgDonateAllVestingTokens": {
        aminoType: string;
        toAmino: ({ fromAddress }: MsgDonateAllVestingTokens) => MsgDonateAllVestingTokensAminoType["value"];
        fromAmino: ({ from_address }: MsgDonateAllVestingTokensAminoType["value"]) => MsgDonateAllVestingTokens;
    };
};
