...
export interface MsgDonateAllVestingTokensProtoMsg {
 ...
 * token to community pool.
 */
export interface MsgDonateAllVestingTokensAmino {
  from_address?: string;
}
export interface MsgDonateAllVestingTokensAminoMsg {
  type: "cosmos-sdk/MsgDonateAllVestingTokens";
  value: MsgDonateAllVestingTokensAmino;
}
/**
 * MsgDonateAllVestingTokens defines a message that enables donating all vesting
 * token to community pool.
...
export interface MsgDonateAllVestingTokensResponseProtoMsg {
  typeUrl: "/cosmos.vesting.v1beta1.MsgDonateAllVestingTokensResponse";
  value: Uint8Array;
}
/**
 * MsgDonateAllVestingTokensResponse defines the Msg/MsgDonateAllVestingTokens
 * response type.
 */
export interface MsgDonateAllVestingTokensResponseAmino {}
export interface MsgDonateAllVestingTokensResponseAminoMsg {
  type: "cosmos-sdk/MsgDonateAllVestingTokensResponse";
  value: MsgDonateAllVestingTokensResponseAmino;
}
/**
 * MsgDonateAllVestingTokensResponse defines the Msg/MsgDonateAllVestingTokens
 * response type.
...
export const MsgDonateAllVestingTokens = {
  typeUrl: "/cosmos.vesting.v1beta1.MsgDonateAllVestingTokens",
  encode(message: MsgDonateAllVestingTokens, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.fromAddress !== "") {
      writer.uint32(10).string(message.fromAddress);
    }
    return writer;
  ...
  fromPartial(object: Partial<MsgDonateAllVestingTokens>): MsgDonateAllVestingTokens {
    const message = createBaseMsgDonateAllVestingTokens();
    message.fromAddress = object.fromAddress ?? "";
    return message;
  },
  fromAmino(object: MsgDonateAllVestingTokensAmino): MsgDonateAllVestingTokens {
    const message = createBaseMsgDonateAllVestingTokens();
    if (object.from_address !== undefined && object.from_address !== null) {
      message.fromAddress = object.from_address;
    }
  ...
  toAmino(message: MsgDonateAllVestingTokens): MsgDonateAllVestingTokensAmino {
    const obj: any = {};
    obj.from_address = message.fromAddress === "" ? undefined : message.fromAddress;
    return obj;
  },
  fromAminoMsg(object: MsgDonateAllVestingTokensAminoMsg): MsgDonateAllVestingTokens {
    return MsgDonateAllVestingTokens.fromAmino(object.value);
  },
  toAminoMsg(message: MsgDonateAllVestingTokens): MsgDonateAllVestingTokensAminoMsg {
    return {
      type: "cosmos-sdk/MsgDonateAllVestingTokens",
      value: MsgDonateAllVestingTokens.toAmino(message)
    };
  },
  fromProtoMsg(message: MsgDonateAllVestingTokensProtoMsg): MsgDonateAllVestingTokens {
    return MsgDonateAllVestingTokens.decode(message.value);
  },
  toProto(message: MsgDonateAllVestingTokens): Uint8Array {
    return MsgDonateAllVestingTokens.encode(message).finish();
  },
  toProtoMsg(message: MsgDonateAllVestingTokens): MsgDonateAllVestingTokensProtoMsg {
    return {
      typeUrl: "/cosmos.vesting.v1beta1.MsgDonateAllVestingTokens",
      value: MsgDonateAllVestingTokens.encode(message).finish()
    };
  }
};
...
export const MsgDonateAllVestingTokensResponse = {
  typeUrl: "/cosmos.vesting.v1beta1.MsgDonateAllVestingTokensResponse",
  encode(_: MsgDonateAllVestingTokensResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    return writer;
  },
  fromJSON(_: any): MsgDonateAllVestingTokensResponse {
    return {};
  },
  fromPartial(_: Partial<MsgDonateAllVestingTokensResponse>): MsgDonateAllVestingTokensResponse {
    const message = createBaseMsgDonateAllVestingTokensResponse();
    return message;
  },
  fromAmino(_: MsgDonateAllVestingTokensResponseAmino): MsgDonateAllVestingTokensResponse {
    const message = createBaseMsgDonateAllVestingTokensResponse();
    return message;
  },
  toAmino(_: MsgDonateAllVestingTokensResponse): MsgDonateAllVestingTokensResponseAmino {
    const obj: any = {};
    return obj;
  },
  fromAminoMsg(object: MsgDonateAllVestingTokensResponseAminoMsg): MsgDonateAllVestingTokensResponse {
    return MsgDonateAllVestingTokensResponse.fromAmino(object.value);
  },
  toAminoMsg(message: MsgDonateAllVestingTokensResponse): MsgDonateAllVestingTokensResponseAminoMsg {
    return {
      type: "cosmos-sdk/MsgDonateAllVestingTokensResponse",
      value: MsgDonateAllVestingTokensResponse.toAmino(message)
    };
  },
  fromProtoMsg(message: MsgDonateAllVestingTokensResponseProtoMsg): MsgDonateAllVestingTokensResponse {
    return MsgDonateAllVestingTokensResponse.decode(message.value);
  },
  toProto(message: MsgDonateAllVestingTokensResponse): Uint8Array {
    return MsgDonateAllVestingTokensResponse.encode(message).finish();
  },
  toProtoMsg(message: MsgDonateAllVestingTokensResponse): MsgDonateAllVestingTokensResponseProtoMsg {
    return {
      typeUrl: "/cosmos.vesting.v1beta1.MsgDonateAllVestingTokensResponse",
      value: MsgDonateAllVestingTokensResponse.encode(message).finish()
    };
  }
};