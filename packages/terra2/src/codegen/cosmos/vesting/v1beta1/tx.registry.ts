...
export const registry: ReadonlyArray<[string, GeneratedType]> = [["/cosmos.vesting.v1beta1.MsgCreateVestingAccount", MsgCreateVestingAccount], ["/cosmos.vesting.v1beta1.MsgCreatePermanentLockedAccount", MsgCreatePermanentLockedAccount], ["/cosmos.vesting.v1beta1.MsgCreatePeriodicVestingAccount", MsgCreatePeriodicVestingAccount], ["/cosmos.vesting.v1beta1.MsgDonateAllVestingTokens", MsgDonateAllVestingTokens]];
...
export const MessageComposer = {
  ...
  fromJSON: {
    ...
    donateAllVestingTokens(value: any) {
      return {
        typeUrl: "/cosmos.vesting.v1beta1.MsgDonateAllVestingTokens",
        value: MsgDonateAllVestingTokens.fromJSON(value)
      };
    }
  },
  fromPartial: {
