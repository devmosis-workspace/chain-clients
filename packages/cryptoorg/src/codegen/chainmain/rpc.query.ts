...
export const createRPCQueryClient = async ({
  ...
  return {
    chainmain: {
      icaauth: {
        v1: (await import("../icaauth/v1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      nft_transfer: {
        v1: (await import("../nft_transfer/v1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      nft: {
