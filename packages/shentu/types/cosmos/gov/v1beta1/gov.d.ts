...
export interface Proposal {
    proposalId: bigint;
    content?: (TextProposal & Compilation & Auditing & Proof & OracleOperator & ShieldPoolCreator & Identity & General & BountyAdmin & Any) | undefined;
...
export type ProposalEncoded = Omit<Proposal, "content"> & {
    content?: TextProposalProtoMsg | CompilationProtoMsg | AuditingProtoMsg | ProofProtoMsg | OracleOperatorProtoMsg | ShieldPoolCreatorProtoMsg | IdentityProtoMsg | GeneralProtoMsg | BountyAdminProtoMsg | AnyProtoMsg | undefined;
};
/** Proposal defines the core field members of a governance proposal. */
...
export interface ProposalSDKType {
    proposal_id: bigint;
    content?: TextProposalSDKType | CompilationSDKType | AuditingSDKType | ProofSDKType | OracleOperatorSDKType | ShieldPoolCreatorSDKType | IdentitySDKType | GeneralSDKType | BountyAdminSDKType | AnySDKType | undefined;
    status: ProposalStatus;
