import { Deposit, DepositAmino, DepositSDKType, Vote, VoteAmino, VoteSDKType, Proposal, ProposalAmino, ProposalSDKType, DepositParams, DepositParamsAmino, DepositParamsSDKType, VotingParams, VotingParamsAmino, VotingParamsSDKType, TallyParams, TallyParamsAmino, TallyParamsSDKType } from "../../../cosmos/gov/v1beta1/gov";
...
export interface GenesisState {
  ...
  certVotedProposalIds: bigint[];
}
export interface GenesisStateProtoMsg {
  typeUrl: "/shentu.gov.v1alpha1.GenesisState";
  value: Uint8Array;
}
/** GenesisState defines the gov module's genesis state. */
export interface GenesisStateAmino {
  ...
  /** proposals that require and have passed cert votes. */
  cert_voted_proposal_ids?: string[];
}
export interface GenesisStateAminoMsg {
  type: "/shentu.gov.v1alpha1.GenesisState";
...
export interface GenesisStateSDKType {
  ...
  cert_voted_proposal_ids: bigint[];
}
...
export const GenesisState = {
  ...
  encode(message: GenesisState, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    ...
    if (message.customParams !== undefined) {
      CustomParams.encode(message.customParams, writer.uint32(66).fork()).ldelim();
    }
    writer.uint32(74).fork();
    for (const v of message.certVotedProposalIds) {
      writer.uint64(v);
    }
    writer.ldelim();
    return writer;
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      certVotedProposalIds: Array.isArray(object?.certVotedProposalIds) ? object.certVotedProposalIds.map((e: any) => BigInt(e.toString())) : []
    };
  },
  fromPartial(object: Partial<GenesisState>): GenesisState {
    ...
    message.certVotedProposalIds = object.certVotedProposalIds?.map(e => BigInt(e.toString())) || [];
    return message;
  },
  fromAmino(object: GenesisStateAmino): GenesisState {
    ...
    message.certVotedProposalIds = object.cert_voted_proposal_ids?.map(e => BigInt(e)) || [];
    return message;
  },
  toAmino(message: GenesisState): GenesisStateAmino {
    ...
    if (message.certVotedProposalIds) {
      obj.cert_voted_proposal_ids = message.certVotedProposalIds.map(e => e.toString());
    } else {
      obj.cert_voted_proposal_ids = message.certVotedProposalIds;
    }
    return obj;
  },
