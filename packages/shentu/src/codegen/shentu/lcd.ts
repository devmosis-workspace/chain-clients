...
export const createLCDClient = async ({
  ...
  return {
    shentu: {
      bounty: {
        v1: new (await import("./bounty/v1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      cert: {
        v1alpha1: new (await import("./cert/v1alpha1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      cvm: {
        v1alpha1: new (await import("./cvm/v1alpha1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      gov: {
        v1alpha1: new (await import("./gov/v1alpha1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      oracle: {
        v1alpha1: new (await import("./oracle/v1alpha1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      shield: {
        v1alpha1: new (await import("./shield/v1alpha1/query.lcd")).LCDQueryClient({
          requestClient
        })
      }
    },
