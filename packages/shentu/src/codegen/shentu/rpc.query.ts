...
export const createRPCQueryClient = async ({
  ...
  return {
    shentu: {
      bounty: {
        v1: (await import("./bounty/v1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      cert: {
        v1alpha1: (await import("./cert/v1alpha1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      cvm: {
        v1alpha1: (await import("./cvm/v1alpha1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      gov: {
        v1alpha1: (await import("./gov/v1alpha1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      oracle: {
        v1alpha1: (await import("./oracle/v1alpha1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      shield: {
        v1alpha1: (await import("./shield/v1alpha1/query.rpc.Query")).createRpcQueryExtension(client)
      }
    },
    cosmos: {
      auth: {
