...
export const OrderRemoval = {
  ...
  fromJSON(object: any): OrderRemoval {
    return {
      orderId: isSet(object.orderId) ? OrderId.fromJSON(object.orderId) : undefined,
      removalReason: isSet(object.removalReason) ? orderRemoval_RemovalReasonFromJSON(object.removalReason) : -1
    };
  },
  ...
  toAmino(message: OrderRemoval): OrderRemovalAmino {
    ...
    obj.removal_reason = message.removalReason;
    return obj;
  },
