...
export const BlockRateLimitConfiguration = {
  ...
  fromJSON(object: any): BlockRateLimitConfiguration {
    return {
      maxShortTermOrdersPerNBlocks: Array.isArray(object?.maxShortTermOrdersPerNBlocks) ? object.maxShortTermOrdersPerNBlocks.map((e: any) => MaxPerNBlocksRateLimit.fromJSON(e)) : [],
      maxStatefulOrdersPerNBlocks: Array.isArray(object?.maxStatefulOrdersPerNBlocks) ? object.maxStatefulOrdersPerNBlocks.map((e: any) => MaxPerNBlocksRateLimit.fromJSON(e)) : [],
      maxShortTermOrderCancellationsPerNBlocks: Array.isArray(object?.maxShortTermOrderCancellationsPerNBlocks) ? object.maxShortTermOrderCancellationsPerNBlocks.map((e: any) => MaxPerNBlocksRateLimit.fromJSON(e)) : []
    };
  },
...
export const MaxPerNBlocksRateLimit = {
  ...
  fromJSON(object: any): MaxPerNBlocksRateLimit {
    return {
