...
export const OrderId = {
  ...
  fromJSON(object: any): OrderId {
    return {
      ...
      orderFlags: isSet(object.orderFlags) ? Number(object.orderFlags) : 0,
...
export const OrdersFilledDuringLatestBlock = {
  ...
  fromJSON(object: any): OrdersFilledDuringLatestBlock {
    return {
      orderIds: Array.isArray(object?.orderIds) ? object.orderIds.map((e: any) => OrderId.fromJSON(e)) : []
    };
  },
...
export const PotentiallyPrunableOrders = {
  ...
  fromJSON(object: any): PotentiallyPrunableOrders {
    return {
      orderIds: Array.isArray(object?.orderIds) ? object.orderIds.map((e: any) => OrderId.fromJSON(e)) : []
    };
  },
...
export const OrderFillState = {
  ...
  fromJSON(object: any): OrderFillState {
    return {
      fillAmount: isSet(object.fillAmount) ? BigInt(object.fillAmount.toString()) : BigInt(0),
      prunableBlockHeight: isSet(object.prunableBlockHeight) ? Number(object.prunableBlockHeight) : 0
    };
  },
...
export const StatefulOrderTimeSliceValue = {
  ...
  fromJSON(object: any): StatefulOrderTimeSliceValue {
    return {
      orderIds: Array.isArray(object?.orderIds) ? object.orderIds.map((e: any) => OrderId.fromJSON(e)) : []
    };
  },
...
export const LongTermOrderPlacement = {
  ...
  fromJSON(object: any): LongTermOrderPlacement {
    return {
      order: isSet(object.order) ? Order.fromJSON(object.order) : undefined,
      placementIndex: isSet(object.placementIndex) ? TransactionOrdering.fromJSON(object.placementIndex) : undefined
    };
  },
...
export const ConditionalOrderPlacement = {
  ...
  fromJSON(object: any): ConditionalOrderPlacement {
    return {
      order: isSet(object.order) ? Order.fromJSON(object.order) : undefined,
      placementIndex: isSet(object.placementIndex) ? TransactionOrdering.fromJSON(object.placementIndex) : undefined,
      triggerIndex: isSet(object.triggerIndex) ? TransactionOrdering.fromJSON(object.triggerIndex) : undefined
    };
  },
...
export const Order = {
  ...
  fromJSON(object: any): Order {
    return {
      ...
      goodTilBlock: isSet(object.goodTilBlock) ? Number(object.goodTilBlock) : undefined,
      goodTilBlockTime: isSet(object.goodTilBlockTime) ? Number(object.goodTilBlockTime) : undefined,
      timeInForce: isSet(object.timeInForce) ? order_TimeInForceFromJSON(object.timeInForce) : -1,
      reduceOnly: isSet(object.reduceOnly) ? Boolean(object.reduceOnly) : false,
      clientMetadata: isSet(object.clientMetadata) ? Number(object.clientMetadata) : 0,
      conditionType: isSet(object.conditionType) ? order_ConditionTypeFromJSON(object.conditionType) : -1,
      conditionalOrderTriggerSubticks: isSet(object.conditionalOrderTriggerSubticks) ? BigInt(object.conditionalOrderTriggerSubticks.toString()) : BigInt(0)
    };
  },
  ...
  toAmino(message: Order): OrderAmino {
    ...
    obj.condition_type = message.conditionType;
...
export const TransactionOrdering = {
  ...
  fromJSON(object: any): TransactionOrdering {
    return {
