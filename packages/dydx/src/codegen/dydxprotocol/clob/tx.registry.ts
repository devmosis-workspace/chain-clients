...
export const MessageComposer = {
  ...
  fromJSON: {
    proposedOperations(value: any) {
      return {
        typeUrl: "/dydxprotocol.clob.MsgProposedOperations",
        value: MsgProposedOperations.fromJSON(value)
      };
    },
    placeOrder(value: any) {
      return {
        typeUrl: "/dydxprotocol.clob.MsgPlaceOrder",
        value: MsgPlaceOrder.fromJSON(value)
      };
    },
    ...
    createClobPair(value: any) {
      return {
        typeUrl: "/dydxprotocol.clob.MsgCreateClobPair",
        value: MsgCreateClobPair.fromJSON(value)
      };
    },
    updateClobPair(value: any) {
      return {
        typeUrl: "/dydxprotocol.clob.MsgUpdateClobPair",
        value: MsgUpdateClobPair.fromJSON(value)
      };
    },
    updateEquityTierLimitConfiguration(value: any) {
      return {
        typeUrl: "/dydxprotocol.clob.MsgUpdateEquityTierLimitConfiguration",
        value: MsgUpdateEquityTierLimitConfiguration.fromJSON(value)
      };
    },
    updateBlockRateLimitConfiguration(value: any) {
      return {
        typeUrl: "/dydxprotocol.clob.MsgUpdateBlockRateLimitConfiguration",
        value: MsgUpdateBlockRateLimitConfiguration.fromJSON(value)
      };
    },
    updateLiquidationsConfig(value: any) {
      return {
        typeUrl: "/dydxprotocol.clob.MsgUpdateLiquidationsConfig",
        value: MsgUpdateLiquidationsConfig.fromJSON(value)
      };
    }
  },
  fromPartial: {
