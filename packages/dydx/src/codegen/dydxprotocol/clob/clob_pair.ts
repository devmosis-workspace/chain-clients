...
export const PerpetualClobMetadata = {
  ...
  fromJSON(object: any): PerpetualClobMetadata {
    return {
...
export const SpotClobMetadata = {
  ...
  fromJSON(object: any): SpotClobMetadata {
    return {
      baseAssetId: isSet(object.baseAssetId) ? Number(object.baseAssetId) : 0,
      quoteAssetId: isSet(object.quoteAssetId) ? Number(object.quoteAssetId) : 0
    };
  },
...
export const ClobPair = {
  ...
  fromJSON(object: any): ClobPair {
    return {
      id: isSet(object.id) ? Number(object.id) : 0,
      perpetualClobMetadata: isSet(object.perpetualClobMetadata) ? PerpetualClobMetadata.fromJSON(object.perpetualClobMetadata) : undefined,
      spotClobMetadata: isSet(object.spotClobMetadata) ? SpotClobMetadata.fromJSON(object.spotClobMetadata) : undefined,
