...
export const IndexerOrderId = {
  ...
  fromJSON(object: any): IndexerOrderId {
    return {
...
export const IndexerOrder = {
  ...
  fromJSON(object: any): IndexerOrder {
    return {
      ...
      timeInForce: isSet(object.timeInForce) ? indexerOrder_TimeInForceFromJSON(object.timeInForce) : -1,
      ...
      conditionType: isSet(object.conditionType) ? indexerOrder_ConditionTypeFromJSON(object.conditionType) : -1,
