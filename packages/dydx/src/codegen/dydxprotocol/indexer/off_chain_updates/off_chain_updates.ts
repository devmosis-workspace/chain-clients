...
export const OrderPlaceV1 = {
  ...
  fromJSON(object: any): OrderPlaceV1 {
    return {
      order: isSet(object.order) ? IndexerOrder.fromJSON(object.order) : undefined,
      placementStatus: isSet(object.placementStatus) ? orderPlaceV1_OrderPlacementStatusFromJSON(object.placementStatus) : -1
    };
  },
  ...
  toAmino(message: OrderPlaceV1): OrderPlaceV1Amino {
    ...
    obj.placement_status = message.placementStatus;
    return obj;
  },
...
export const OrderRemoveV1 = {
  ...
  fromJSON(object: any): OrderRemoveV1 {
    return {
      ...
      removalStatus: isSet(object.removalStatus) ? orderRemoveV1_OrderRemovalStatusFromJSON(object.removalStatus) : -1
    };
  },
  ...
  toAmino(message: OrderRemoveV1): OrderRemoveV1Amino {
    ...
    obj.removal_status = message.removalStatus;
    return obj;
  },
...
export const OrderUpdateV1 = {
  ...
  fromJSON(object: any): OrderUpdateV1 {
    return {
      orderId: isSet(object.orderId) ? IndexerOrderId.fromJSON(object.orderId) : undefined,
      totalFilledQuantums: isSet(object.totalFilledQuantums) ? BigInt(object.totalFilledQuantums.toString()) : BigInt(0)
    };
  },
...
export const OffChainUpdateV1 = {
  ...
  fromJSON(object: any): OffChainUpdateV1 {
    return {
      orderPlace: isSet(object.orderPlace) ? OrderPlaceV1.fromJSON(object.orderPlace) : undefined,
      orderRemove: isSet(object.orderRemove) ? OrderRemoveV1.fromJSON(object.orderRemove) : undefined,
      orderUpdate: isSet(object.orderUpdate) ? OrderUpdateV1.fromJSON(object.orderUpdate) : undefined
    };
  },
