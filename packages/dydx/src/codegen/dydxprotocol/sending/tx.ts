...
export const MsgCreateTransfer = {
  ...
  fromJSON(object: any): MsgCreateTransfer {
    return {
...
export const MsgCreateTransferResponse = {
  ...
  fromJSON(_: any): MsgCreateTransferResponse {
    return {};
  },
...
export const MsgDepositToSubaccountResponse = {
  ...
  fromJSON(_: any): MsgDepositToSubaccountResponse {
    return {};
  },
...
export const MsgWithdrawFromSubaccountResponse = {
  ...
  fromJSON(_: any): MsgWithdrawFromSubaccountResponse {
    return {};
  },
...
export const MsgSendFromModuleToAccountResponse = {
  ...
  fromJSON(_: any): MsgSendFromModuleToAccountResponse {
    return {};
  },
