...
export const MessageComposer = {
  ...
  fromJSON: {
    createTransfer(value: any) {
      return {
        typeUrl: "/dydxprotocol.sending.MsgCreateTransfer",
        value: MsgCreateTransfer.fromJSON(value)
      };
    },
    depositToSubaccount(value: any) {
      return {
        typeUrl: "/dydxprotocol.sending.MsgDepositToSubaccount",
        value: MsgDepositToSubaccount.fromJSON(value)
      };
    },
    withdrawFromSubaccount(value: any) {
      return {
        typeUrl: "/dydxprotocol.sending.MsgWithdrawFromSubaccount",
        value: MsgWithdrawFromSubaccount.fromJSON(value)
      };
    },
    sendFromModuleToAccount(value: any) {
      return {
        typeUrl: "/dydxprotocol.sending.MsgSendFromModuleToAccount",
        value: MsgSendFromModuleToAccount.fromJSON(value)
      };
    }
  },
  fromPartial: {
