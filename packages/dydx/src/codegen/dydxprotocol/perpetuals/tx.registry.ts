...
export const MessageComposer = {
  ...
  fromJSON: {
    addPremiumVotes(value: any) {
      return {
        typeUrl: "/dydxprotocol.perpetuals.MsgAddPremiumVotes",
        value: MsgAddPremiumVotes.fromJSON(value)
      };
    },
    createPerpetual(value: any) {
      return {
        typeUrl: "/dydxprotocol.perpetuals.MsgCreatePerpetual",
        value: MsgCreatePerpetual.fromJSON(value)
      };
    },
    setLiquidityTier(value: any) {
      return {
        typeUrl: "/dydxprotocol.perpetuals.MsgSetLiquidityTier",
        value: MsgSetLiquidityTier.fromJSON(value)
      };
    },
    updatePerpetualParams(value: any) {
      return {
        typeUrl: "/dydxprotocol.perpetuals.MsgUpdatePerpetualParams",
        value: MsgUpdatePerpetualParams.fromJSON(value)
      };
    },
