...
export const QueryMarketPriceRequest = {
  ...
  fromJSON(object: any): QueryMarketPriceRequest {
    return {
...
export const QueryMarketPriceResponse = {
  ...
  fromJSON(object: any): QueryMarketPriceResponse {
    return {
      marketPrice: isSet(object.marketPrice) ? MarketPrice.fromJSON(object.marketPrice) : undefined
    };
  },
...
export const QueryAllMarketPricesRequest = {
  ...
  fromJSON(object: any): QueryAllMarketPricesRequest {
    return {
...
export const QueryAllMarketPricesResponse = {
  ...
  fromJSON(object: any): QueryAllMarketPricesResponse {
    return {
...
export const QueryMarketParamRequest = {
  ...
  fromJSON(object: any): QueryMarketParamRequest {
    return {
      id: isSet(object.id) ? Number(object.id) : 0
    };
  },
...
export const QueryMarketParamResponse = {
  ...
  fromJSON(object: any): QueryMarketParamResponse {
    return {
...
export const QueryAllMarketParamsRequest = {
  ...
  fromJSON(object: any): QueryAllMarketParamsRequest {
    return {
      pagination: isSet(object.pagination) ? PageRequest.fromJSON(object.pagination) : undefined
    };
  },
...
export const QueryAllMarketParamsResponse = {
  ...
  fromJSON(object: any): QueryAllMarketParamsResponse {
    return {
