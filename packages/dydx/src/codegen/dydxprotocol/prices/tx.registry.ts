...
export const MessageComposer = {
  ...
  fromJSON: {
    updateMarketPrices(value: any) {
      return {
        typeUrl: "/dydxprotocol.prices.MsgUpdateMarketPrices",
        value: MsgUpdateMarketPrices.fromJSON(value)
      };
    },
    createOracleMarket(value: any) {
      return {
        typeUrl: "/dydxprotocol.prices.MsgCreateOracleMarket",
        value: MsgCreateOracleMarket.fromJSON(value)
      };
    },
    updateMarketParam(value: any) {
      return {
        typeUrl: "/dydxprotocol.prices.MsgUpdateMarketParam",
        value: MsgUpdateMarketParam.fromJSON(value)
      };
    }
  },
  fromPartial: {
