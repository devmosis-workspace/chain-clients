...
export const MessageComposer = {
  ...
  fromJSON: {
    acknowledgeBridges(value: any) {
      return {
        typeUrl: "/dydxprotocol.bridge.MsgAcknowledgeBridges",
        value: MsgAcknowledgeBridges.fromJSON(value)
      };
    },
    completeBridge(value: any) {
      return {
        typeUrl: "/dydxprotocol.bridge.MsgCompleteBridge",
        value: MsgCompleteBridge.fromJSON(value)
      };
    },
    updateEventParams(value: any) {
      return {
        typeUrl: "/dydxprotocol.bridge.MsgUpdateEventParams",
        value: MsgUpdateEventParams.fromJSON(value)
      };
    },
    updateProposeParams(value: any) {
      return {
        typeUrl: "/dydxprotocol.bridge.MsgUpdateProposeParams",
        value: MsgUpdateProposeParams.fromJSON(value)
      };
    },
    updateSafetyParams(value: any) {
      return {
        typeUrl: "/dydxprotocol.bridge.MsgUpdateSafetyParams",
        value: MsgUpdateSafetyParams.fromJSON(value)
      };
    }
  },
  fromPartial: {
