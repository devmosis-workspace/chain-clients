...
export const EventParams = {
  ...
  fromJSON(object: any): EventParams {
    return {
      denom: isSet(object.denom) ? String(object.denom) : "",
      ethChainId: isSet(object.ethChainId) ? BigInt(object.ethChainId.toString()) : BigInt(0),
...
export const ProposeParams = {
  ...
  fromJSON(object: any): ProposeParams {
    return {
      maxBridgesPerBlock: isSet(object.maxBridgesPerBlock) ? Number(object.maxBridgesPerBlock) : 0,
      proposeDelayDuration: isSet(object.proposeDelayDuration) ? Duration.fromJSON(object.proposeDelayDuration) : undefined,
      skipRatePpm: isSet(object.skipRatePpm) ? Number(object.skipRatePpm) : 0,
      skipIfBlockDelayedByDuration: isSet(object.skipIfBlockDelayedByDuration) ? Duration.fromJSON(object.skipIfBlockDelayedByDuration) : undefined
    };
  },
...
export const SafetyParams = {
  ...
  fromJSON(object: any): SafetyParams {
    return {
