...
export const createLCDClient = async ({
  ...
  return {
    dymensionxyz: {
      dymension: {
        rollapp: new (await import("../dymension/rollapp/query.lcd")).LCDQueryClient({
          requestClient
        }),
        sequencer: new (await import("../dymension/sequencer/query.lcd")).LCDQueryClient({
          requestClient
        }),
        streamer: new (await import("../dymension/streamer/query.lcd")).LCDQueryClient({
          requestClient
        })
      }
    },
