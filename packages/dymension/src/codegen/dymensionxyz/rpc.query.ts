...
export const createRPCQueryClient = async ({
  ...
  return {
    dymensionxyz: {
      dymension: {
        rollapp: (await import("../dymension/rollapp/query.rpc.Query")).createRpcQueryExtension(client),
        sequencer: (await import("../dymension/sequencer/query.rpc.Query")).createRpcQueryExtension(client),
        streamer: (await import("../dymension/streamer/query.rpc.Query")).createRpcQueryExtension(client)
      }
    },
    cosmos: {
      app: {
