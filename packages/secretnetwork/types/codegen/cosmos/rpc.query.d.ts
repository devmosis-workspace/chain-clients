    ...
    cosmos: {
        ...
        distribution: {
            v1beta1: {
                ...
                foundationTax(request?: import("./distribution/v1beta1/query").QueryFoundationTaxRequest): Promise<import("./distribution/v1beta1/query").QueryFoundationTaxResponse>;
                restakeThreshold(request?: import("./distribution/v1beta1/query").QueryRestakeThresholdRequest): Promise<import("./distribution/v1beta1/query").QueryRestakeThresholdResponse>;
                restakingEntries(request: import("./distribution/v1beta1/query").QueryRestakeEntriesRequest): Promise<import("./distribution/v1beta1/query").QueryRestakingEntriesResponse>;
            };
        };
        evidence: {
            v1beta1: {
