...
export interface MsgSetAutoRestakeAminoType extends AminoMsg {
...
export declare const AminoConverter: {
    ...
    "/cosmos.distribution.v1beta1.MsgSetAutoRestake": {
        aminoType: string;
        toAmino: ({ delegatorAddress, validatorAddress, enabled }: MsgSetAutoRestake) => MsgSetAutoRestakeAminoType["value"];
        fromAmino: ({ delegator_address, validator_address, enabled }: MsgSetAutoRestakeAminoType["value"]) => MsgSetAutoRestake;
    };
};
