...
export declare const cosmosAminoConverters: {
    ...
    "/cosmos.distribution.v1beta1.MsgSetAutoRestake": {
        aminoType: string;
        toAmino: (message: import("./distribution/v1beta1/tx").MsgSetAutoRestake) => import("./distribution/v1beta1/tx").MsgSetAutoRestakeAmino;
        fromAmino: (object: import("./distribution/v1beta1/tx").MsgSetAutoRestakeAmino) => import("./distribution/v1beta1/tx").MsgSetAutoRestake;
    };
