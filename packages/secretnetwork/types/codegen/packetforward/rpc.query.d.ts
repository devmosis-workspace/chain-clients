...
export declare const createRPCQueryClient: ({ rpcEndpoint }: {
    ...
    packetforward: {
        v1: {
            params(request?: import("../ibc/applications/packetforward/v1/query").QueryParamsRequest): Promise<import("../ibc/applications/packetforward/v1/query").QueryParamsResponse>;
        };
    };
}>;
