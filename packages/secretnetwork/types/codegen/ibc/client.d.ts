...
export declare const ibcAminoConverters: {
    ...
    "/ibc.applications.fee.v1.MsgRegisterPayee": {
        aminoType: string;
        toAmino: ({ portId, channelId, relayer, payee }: import("./applications/fee/v1/tx").MsgRegisterPayee) => {
            port_id: string;
            channel_id: string;
            relayer: string;
            payee: string;
        ...
        fromAmino: ({ port_id, channel_id, relayer, payee }: {
            ...
            relayer: string;
            payee: string;
        }) => import("./applications/fee/v1/tx").MsgRegisterPayee;
    };
    "/ibc.applications.fee.v1.MsgRegisterCounterpartyPayee": {
        aminoType: string;
        toAmino: ({ portId, channelId, relayer, counterpartyPayee }: import("./applications/fee/v1/tx").MsgRegisterCounterpartyPayee) => {
            port_id: string;
            channel_id: string;
            relayer: string;
        ...
        fromAmino: ({ port_id, channel_id, relayer, counterparty_payee }: {
            ...
            relayer: string;
            counterparty_payee: string;
        }) => import("./applications/fee/v1/tx").MsgRegisterCounterpartyPayee;
    };
