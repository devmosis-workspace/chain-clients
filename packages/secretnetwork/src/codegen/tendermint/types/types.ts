...
export interface HeaderAmino {
  ...
  /** encrypted random */
  encrypted_random?: EncryptedRandomAmino;
}
...
export interface HeaderSDKType {
  ...
  encrypted_random?: EncryptedRandomSDKType;
}
...
export interface EncryptedRandomProtoMsg {
  typeUrl: "/tendermint.types.EncryptedRandom";
  value: Uint8Array;
}
/** Data contains the set of transactions included in the block */
export interface EncryptedRandomAmino {
  random?: string;
  proof?: string;
}
export interface EncryptedRandomAminoMsg {
  type: "/tendermint.types.EncryptedRandom";
  value: EncryptedRandomAmino;
}
/** Data contains the set of transactions included in the block */
export interface EncryptedRandomSDKType {
  random: Uint8Array;
  proof: Uint8Array;
}
/** Data contains the set of transactions included in the block */
...
export const Header = {
  ...
  encode(message: Header, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    ...
    if (message.encryptedRandom !== undefined) {
      EncryptedRandom.encode(message.encryptedRandom, writer.uint32(122).fork()).ldelim();
    }
    return writer;
  },
  fromJSON(object: any): Header {
    return {
      ...
      encryptedRandom: isSet(object.encryptedRandom) ? EncryptedRandom.fromJSON(object.encryptedRandom) : undefined
    };
  },
  fromPartial(object: Partial<Header>): Header {
    ...
    message.encryptedRandom = object.encryptedRandom !== undefined && object.encryptedRandom !== null ? EncryptedRandom.fromPartial(object.encryptedRandom) : undefined;
    return message;
  },
  fromAmino(object: HeaderAmino): Header {
    ...
    if (object.encrypted_random !== undefined && object.encrypted_random !== null) {
      message.encryptedRandom = EncryptedRandom.fromAmino(object.encrypted_random);
    }
    return message;
  },
  toAmino(message: Header): HeaderAmino {
    ...
    obj.encrypted_random = message.encryptedRandom ? EncryptedRandom.toAmino(message.encryptedRandom) : undefined;
    return obj;
  },
...
export const EncryptedRandom = {
  typeUrl: "/tendermint.types.EncryptedRandom",
  encode(message: EncryptedRandom, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
  ...
  fromJSON(object: any): EncryptedRandom {
    return {
      random: isSet(object.random) ? bytesFromBase64(object.random) : new Uint8Array(),
      proof: isSet(object.proof) ? bytesFromBase64(object.proof) : new Uint8Array()
    };
  },
  fromPartial(object: Partial<EncryptedRandom>): EncryptedRandom {
    const message = createBaseEncryptedRandom();
    message.random = object.random ?? new Uint8Array();
    message.proof = object.proof ?? new Uint8Array();
    return message;
  },
  fromAmino(object: EncryptedRandomAmino): EncryptedRandom {
    const message = createBaseEncryptedRandom();
    if (object.random !== undefined && object.random !== null) {
      message.random = bytesFromBase64(object.random);
    }
    if (object.proof !== undefined && object.proof !== null) {
  ...
  toAmino(message: EncryptedRandom): EncryptedRandomAmino {
    const obj: any = {};
    obj.random = message.random ? base64FromBytes(message.random) : undefined;
    obj.proof = message.proof ? base64FromBytes(message.proof) : undefined;
    return obj;
  },
  fromAminoMsg(object: EncryptedRandomAminoMsg): EncryptedRandom {
    return EncryptedRandom.fromAmino(object.value);
  },
  fromProtoMsg(message: EncryptedRandomProtoMsg): EncryptedRandom {
    return EncryptedRandom.decode(message.value);
  },
  toProto(message: EncryptedRandom): Uint8Array {
    return EncryptedRandom.encode(message).finish();
  },
  toProtoMsg(message: EncryptedRandom): EncryptedRandomProtoMsg {
    return {
      typeUrl: "/tendermint.types.EncryptedRandom",
      value: EncryptedRandom.encode(message).finish()
    };
  }
};
