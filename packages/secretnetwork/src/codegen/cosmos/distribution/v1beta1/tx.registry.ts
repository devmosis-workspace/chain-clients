...
export const MessageComposer = {
  encoded: {
    ...
    setAutoRestake(value: MsgSetAutoRestake) {
      return {
        ...
        value: MsgSetAutoRestake.encode(value).finish()
      };
    }
  },
  withTypeUrl: {
  ...
  fromJSON: {
    ...
    setAutoRestake(value: any) {
      return {
        typeUrl: "/cosmos.distribution.v1beta1.MsgSetAutoRestake",
        value: MsgSetAutoRestake.fromJSON(value)
      };
    }
  },
  fromPartial: {
    ...
    setAutoRestake(value: MsgSetAutoRestake) {
      return {
        typeUrl: "/cosmos.distribution.v1beta1.MsgSetAutoRestake",
        value: MsgSetAutoRestake.fromPartial(value)
      };
    }
  }
};