...
export const Params = {
  ...
  fromAmino(object: ParamsAmino): Params {
    return {
      ...
      secretFoundationTax: object.secret_foundation_tax,
      secretFoundationAddress: object.secret_foundation_address,
      minimumRestakeThreshold: object.minimum_restake_threshold,
      restakePeriod: object.restake_period
    };
  },
  toAmino(message: Params): ParamsAmino {
    ...
    obj.secret_foundation_tax = message.secretFoundationTax;
    obj.secret_foundation_address = message.secretFoundationAddress;
    obj.minimum_restake_threshold = message.minimumRestakeThreshold;
    obj.restake_period = message.restakePeriod;
    return obj;
  },
