...
export interface Params {
  ...
  minimumRestakeThreshold: string;
  restakePeriod: string;
}
...
export const Params = {
  ...
  encode(message: Params, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    ...
    if (message.secretFoundationTax !== "") {
      writer.uint32(42).string(Decimal.fromUserInput(message.secretFoundationTax, 18).atomics);
    }
    if (message.secretFoundationAddress !== "") {
      writer.uint32(50).string(message.secretFoundationAddress);
    }
    if (message.minimumRestakeThreshold !== "") {
      writer.uint32(58).string(Decimal.fromUserInput(message.minimumRestakeThreshold, 18).atomics);
    }
    if (message.restakePeriod !== "") {
      writer.uint32(66).string(message.restakePeriod);
    }
    return writer;
  },
  fromJSON(object: any): Params {
    return {
      ...
      secretFoundationTax: isSet(object.secretFoundationTax) ? String(object.secretFoundationTax) : "",
      secretFoundationAddress: isSet(object.secretFoundationAddress) ? String(object.secretFoundationAddress) : "",
      minimumRestakeThreshold: isSet(object.minimumRestakeThreshold) ? String(object.minimumRestakeThreshold) : "",
      restakePeriod: isSet(object.restakePeriod) ? String(object.restakePeriod) : ""
    };
  },
  fromPartial(object: Partial<Params>): Params {
    ...
    message.minimumRestakeThreshold = object.minimumRestakeThreshold ?? "";
    message.restakePeriod = object.restakePeriod ?? "";
    return message;
  },
  fromAmino(object: ParamsAmino): Params {
    ...
    if (object.secret_foundation_tax !== undefined && object.secret_foundation_tax !== null) {
      message.secretFoundationTax = object.secret_foundation_tax;
    }
    if (object.secret_foundation_address !== undefined && object.secret_foundation_address !== null) {
      message.secretFoundationAddress = object.secret_foundation_address;
    }
    if (object.minimum_restake_threshold !== undefined && object.minimum_restake_threshold !== null) {
      message.minimumRestakeThreshold = object.minimum_restake_threshold;
    }
    if (object.restake_period !== undefined && object.restake_period !== null) {
      message.restakePeriod = object.restake_period;
    }
    return message;
  },
  toAmino(message: Params): ParamsAmino {
    ...
    obj.secret_foundation_tax = message.secretFoundationTax === "" ? undefined : message.secretFoundationTax;
    obj.secret_foundation_address = message.secretFoundationAddress === "" ? undefined : message.secretFoundationAddress;
    obj.minimum_restake_threshold = message.minimumRestakeThreshold === "" ? undefined : message.minimumRestakeThreshold;
    obj.restake_period = message.restakePeriod === "" ? undefined : message.restakePeriod;
    return obj;
  },
