...
export class LCDQueryClient {
  ...
  /* MissingPeggoNonces */
  async missingPeggoNonces(_params: MissingNoncesRequest = {}): Promise<MissingNoncesResponseSDKType> {
    const endpoint = `peggy/v1/missing_nonces`;
    return await this.req.get<MissingNoncesResponseSDKType>(endpoint);
  }
}