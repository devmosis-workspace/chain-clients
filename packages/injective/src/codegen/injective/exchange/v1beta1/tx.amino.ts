...
export const AminoConverter = {
  ...
  "/injective.exchange.v1beta1.MsgPrivilegedExecuteContract": {
    ...
    toAmino: ({
      ...
      contractAddress,
      data
    }: MsgPrivilegedExecuteContract): MsgPrivilegedExecuteContractAminoType["value"] => {
      return {
        sender,
        funds,
    ...
    fromAmino: ({
      ...
      contract_address,
      data
    }: MsgPrivilegedExecuteContractAminoType["value"]): MsgPrivilegedExecuteContract => {
      return {
        sender,
        funds,
  ...
  "/injective.exchange.v1beta1.MsgReclaimLockedFunds": {
    ...
    toAmino: ({
      ...
      lockedAccountPubKey,
      signature
    }: MsgReclaimLockedFunds): MsgReclaimLockedFundsAminoType["value"] => {
      return {
        sender,
        lockedAccountPubKey,
        signature
    ...
    fromAmino: ({
      ...
      lockedAccountPubKey,
      signature
    }: MsgReclaimLockedFundsAminoType["value"]): MsgReclaimLockedFunds => {
      return {
        sender,
        lockedAccountPubKey,
        signature
