...
export class LCDQueryClient {
  ...
  async params(_params: QueryParamsRequest = {}): Promise<QueryParamsResponseSDKType> {
    const endpoint = `injective/tokenfactory/v1beta1/params`;
  ...
  async denomAuthorityMetadata(params: QueryDenomAuthorityMetadataRequest): Promise<QueryDenomAuthorityMetadataResponseSDKType> {
    const endpoint = `injective/tokenfactory/v1beta1/denoms/${params.creator}/${params.subDenom}/authority_metadata`;
  ...
  async denomsFromCreator(params: QueryDenomsFromCreatorRequest): Promise<QueryDenomsFromCreatorResponseSDKType> {
    const endpoint = `injective/tokenfactory/v1beta1/denoms_from_creator/${params.creator}`;
    return await this.req.get<QueryDenomsFromCreatorResponseSDKType>(endpoint);
  }
  /* Retrieves the entire auction module's state */
  async tokenfactoryModuleState(_params: QueryModuleStateRequest = {}): Promise<QueryModuleStateResponseSDKType> {
    const endpoint = `injective/tokenfactory/v1beta1/module_state`;
