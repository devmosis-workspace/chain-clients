...
export declare const AminoConverter: {
    ...
    "/cosmos.group.v1.MsgUpdateGroupPolicyAdmin": {
        aminoType: string;
        toAmino: ({ admin, groupPolicyAddress, newAdmin }: MsgUpdateGroupPolicyAdmin) => MsgUpdateGroupPolicyAdminAminoType["value"];
        fromAmino: ({ admin, group_policy_address, new_admin }: MsgUpdateGroupPolicyAdminAminoType["value"]) => MsgUpdateGroupPolicyAdmin;
    };
    "/cosmos.group.v1.MsgUpdateGroupPolicyDecisionPolicy": {
        aminoType: string;
        toAmino: ({ admin, groupPolicyAddress, decisionPolicy }: MsgUpdateGroupPolicyDecisionPolicy) => MsgUpdateGroupPolicyDecisionPolicyAminoType["value"];
        fromAmino: ({ admin, group_policy_address, decision_policy }: MsgUpdateGroupPolicyDecisionPolicyAminoType["value"]) => MsgUpdateGroupPolicyDecisionPolicy;
    };
    "/cosmos.group.v1.MsgUpdateGroupPolicyMetadata": {
        aminoType: string;
        toAmino: ({ admin, groupPolicyAddress, metadata }: MsgUpdateGroupPolicyMetadata) => MsgUpdateGroupPolicyMetadataAminoType["value"];
        fromAmino: ({ admin, group_policy_address, metadata }: MsgUpdateGroupPolicyMetadataAminoType["value"]) => MsgUpdateGroupPolicyMetadata;
    };
    "/cosmos.group.v1.MsgSubmitProposal": {
        aminoType: string;
        toAmino: ({ groupPolicyAddress, proposers, metadata, messages, exec, title, summary }: MsgSubmitProposal) => MsgSubmitProposalAminoType["value"];
        fromAmino: ({ group_policy_address, proposers, metadata, messages, exec, title, summary }: MsgSubmitProposalAminoType["value"]) => MsgSubmitProposal;
    };
