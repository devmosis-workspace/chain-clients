...
export const createLCDClient = async ({
  ...
  return {
    agoric: {
      swingset: new (await import("./swingset/query.lcd")).LCDQueryClient({
        requestClient
      }),
      vbank: new (await import("./vbank/query.lcd")).LCDQueryClient({
        requestClient
      }),
      vstorage: new (await import("./vstorage/query.lcd")).LCDQueryClient({
        requestClient
      })
    },
    cosmos: {
