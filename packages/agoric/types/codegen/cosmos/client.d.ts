...
export declare const cosmosAminoConverters: {
    ...
    "/cosmos.vesting.v1beta1.MsgCreatePeriodicVestingAccount": {
        aminoType: string;
        toAmino: ({ fromAddress, toAddress, startTime, vestingPeriods, merge }: import("./vesting/v1beta1/tx").MsgCreatePeriodicVestingAccount) => {
            from_address: string;
            to_address: string;
            start_time: string;
            vesting_periods: {
    ...
    "/cosmos.vesting.v1beta1.MsgCreateClawbackVestingAccount": {
        aminoType: string;
        toAmino: ({ fromAddress, toAddress, startTime, lockupPeriods, vestingPeriods, merge }: import("./vesting/v1beta1/tx").MsgCreateClawbackVestingAccount) => {
            from_address: string;
            to_address: string;
            start_time: string;
            lockup_periods: {
        ...
        fromAmino: ({ from_address, to_address, start_time, lockup_periods, vesting_periods, merge }: {
            ...
            merge: boolean;
        }) => import("./vesting/v1beta1/tx").MsgCreateClawbackVestingAccount;
    };
    "/cosmos.vesting.v1beta1.MsgClawback": {
        aminoType: string;
        toAmino: ({ funderAddress, address, destAddress }: import("./vesting/v1beta1/tx").MsgClawback) => {
        ...
        fromAmino: ({ funder_address, address, dest_address }: {
            ...
            address: string;
            dest_address: string;
        }) => import("./vesting/v1beta1/tx").MsgClawback;
    };
