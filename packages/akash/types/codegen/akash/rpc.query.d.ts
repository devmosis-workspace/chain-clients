...
export declare const createRPCQueryClient: ({ rpcEndpoint }: {
    ...
    akash: {
        audit: {
            v1beta2: {
                allProvidersAttributes(request?: import("./audit/v1beta2/query").QueryAllProvidersAttributesRequest): Promise<import("./audit/v1beta2/query").QueryProvidersResponse>;
                providerAttributes(request: import("./audit/v1beta2/query").QueryProviderAttributesRequest): Promise<import("./audit/v1beta2/query").QueryProvidersResponse>;
        ...
        deployment: {
            v1beta1: {
                deployments(request: import("./deployment/v1beta1/query").QueryDeploymentsRequest): Promise<import("./deployment/v1beta1/query").QueryDeploymentsResponse>;
                deployment(request: import("./deployment/v1beta1/query").QueryDeploymentRequest): Promise<import("./deployment/v1beta1/query").QueryDeploymentResponse>;
                group(request: import("./deployment/v1beta1/query").QueryGroupRequest): Promise<import("./deployment/v1beta1/query").QueryGroupResponse>;
            };
            v1beta2: {
                deployments(request: import("./deployment/v1beta2/query").QueryDeploymentsRequest): Promise<import("./deployment/v1beta2/query").QueryDeploymentsResponse>;
        ...
        escrow: {
            v1beta1: {
                accounts(request: import("./escrow/v1beta1/query").QueryAccountsRequest): Promise<import("./escrow/v1beta1/query").QueryAccountsResponse>;
                payments(request: import("./escrow/v1beta1/query").QueryPaymentsRequest): Promise<import("./escrow/v1beta1/query").QueryPaymentsResponse>;
            };
            v1beta2: {
        ...
        market: {
            v1beta2: {
                orders(request: import("./market/v1beta2/query").QueryOrdersRequest): Promise<import("./market/v1beta2/query").QueryOrdersResponse>;
                order(request: import("./market/v1beta2/query").QueryOrderRequest): Promise<import("./market/v1beta2/query").QueryOrderResponse>;
                bids(request: import("./market/v1beta2/query").QueryBidsRequest): Promise<import("./market/v1beta2/query").QueryBidsResponse>;
                bid(request: import("./market/v1beta2/query").QueryBidRequest): Promise<import("./market/v1beta2/query").QueryBidResponse>;
