...
export const registry: ReadonlyArray<[string, GeneratedType]> = [["/quasarlabs.quasarnode.tokenfactory.v1beta1.MsgCreateDenom", MsgCreateDenom], ["/quasarlabs.quasarnode.tokenfactory.v1beta1.MsgMint", MsgMint], ["/quasarlabs.quasarnode.tokenfactory.v1beta1.MsgBurn", MsgBurn], ["/quasarlabs.quasarnode.tokenfactory.v1beta1.MsgChangeAdmin", MsgChangeAdmin], ["/quasarlabs.quasarnode.tokenfactory.v1beta1.MsgSetDenomMetadata", MsgSetDenomMetadata]];
