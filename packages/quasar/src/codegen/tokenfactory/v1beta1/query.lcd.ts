...
export class LCDQueryClient {
  ...
  async params(_params: QueryParamsRequest = {}): Promise<QueryParamsResponseSDKType> {
    const endpoint = `quasarlabs.quasarnode.tokenfactory.v1beta1/params`;
  ...
  async denomAuthorityMetadata(params: QueryDenomAuthorityMetadataRequest): Promise<QueryDenomAuthorityMetadataResponseSDKType> {
    const endpoint = `quasarlabs.quasarnode.tokenfactory.v1beta1/denoms/${params.denom}/authority_metadata`;
  ...
  async denomsFromCreator(params: QueryDenomsFromCreatorRequest): Promise<QueryDenomsFromCreatorResponseSDKType> {
    const endpoint = `quasarlabs.quasarnode.tokenfactory.v1beta1/denoms_from_creator/${params.creator}`;
