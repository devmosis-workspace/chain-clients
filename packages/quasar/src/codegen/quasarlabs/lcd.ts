  ...
  return {
    quasarlabs: {
      quasarnode: {
        ...
        qoracle: new (await import("../qoracle/query.lcd")).LCDQueryClient({
          requestClient
        }),
        qtransfer: new (await import("../qtransfer/query.lcd")).LCDQueryClient({
          requestClient
        }),
        qvesting: new (await import("../qvesting/query.lcd")).LCDQueryClient({
          requestClient
        }),
        tokenfactory: {
