  ...
  return {
    quasarlabs: {
      quasarnode: {
        ...
        qoracle: (await import("../qoracle/query.rpc.Query")).createRpcQueryExtension(client),
        qtransfer: (await import("../qtransfer/query.rpc.Query")).createRpcQueryExtension(client),
        qvesting: (await import("../qvesting/query.rpc.Query")).createRpcQueryExtension(client),
        tokenfactory: {
