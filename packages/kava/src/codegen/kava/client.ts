...
import * as kavaCommunityV1beta1TxRegistry from "./community/v1beta1/tx.registry";
...
import * as kavaCommunityV1beta1TxAmino from "./community/v1beta1/tx.amino";
...
export const kavaProtoRegistry: ReadonlyArray<[string, GeneratedType]> = [...kavaAuctionV1beta1TxRegistry.registry, ...kavaBep3V1beta1TxRegistry.registry, ...kavaCdpV1beta1TxRegistry.registry, ...kavaCommitteeV1beta1TxRegistry.registry, ...kavaCommunityV1beta1TxRegistry.registry, ...kavaEarnV1beta1TxRegistry.registry, ...kavaEvmutilV1beta1TxRegistry.registry, ...kavaHardV1beta1TxRegistry.registry, ...kavaIncentiveV1beta1TxRegistry.registry, ...kavaIssuanceV1beta1TxRegistry.registry, ...kavaLiquidV1beta1TxRegistry.registry, ...kavaPricefeedV1beta1TxRegistry.registry, ...kavaRouterV1beta1TxRegistry.registry, ...kavaSavingsV1beta1TxRegistry.registry, ...kavaSwapV1beta1TxRegistry.registry];
