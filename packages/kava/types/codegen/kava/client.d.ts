...
export declare const kavaAminoConverters: {
    ...
    "/kava.evmutil.v1beta1.MsgConvertCosmosCoinToERC20": {
        aminoType: string;
        toAmino: ({ initiator, receiver, amount }: import("./evmutil/v1beta1/tx").MsgConvertCosmosCoinToERC20) => {
            initiator: string;
            receiver: string;
            amount: {
                denom: string;
        ...
        }) => import("./evmutil/v1beta1/tx").MsgConvertCosmosCoinToERC20;
    };
    "/kava.evmutil.v1beta1.MsgConvertCosmosCoinFromERC20": {
        aminoType: string;
        toAmino: ({ initiator, receiver, amount }: import("./evmutil/v1beta1/tx").MsgConvertCosmosCoinFromERC20) => {
            initiator: string;
            receiver: string;
            amount: {
                denom: string;
        ...
        }) => import("./evmutil/v1beta1/tx").MsgConvertCosmosCoinFromERC20;
    };
    ...
    "/kava.community.v1beta1.MsgFundCommunityPool": {
        aminoType: string;
        toAmino: ({ amount, depositor }: import("./community/v1beta1/tx").MsgFundCommunityPool) => {
            amount: {
                denom: string;
                amount: string;
            }[];
        ...
        fromAmino: ({ amount, depositor }: {
            ...
            depositor: string;
        }) => import("./community/v1beta1/tx").MsgFundCommunityPool;
    };
