...
export const KeygenSession = {
    ...
    fromJSON(object) {
        return {
            ...
            isPubKeyReceived: isObject(object.isPubKeyReceived) ? Object.entries(object.isPubKeyReceived).reduce((acc, [key, value]) => {
    ...
    fromAmino(object) {
        ...
        message.isPubKeyReceived = Object.entries(object.is_pub_key_received ?? {}).reduce((acc, [key, value]) => {
            if (value !== undefined) {
...
export const MultiSig = {
    ...
    fromJSON(object) {
        return {
            ...
            sigs: isObject(object.sigs) ? Object.entries(object.sigs).reduce((acc, [key, value]) => {
                acc[key] = bytes.fromJSON(value);
                return acc;
            }, {}) : {}
        };
...
export const SigningSession = {
    ...
    toAmino(message) {
        ...
        obj.module_metadata = message.moduleMetadata ? Github_com_cosmos_codec_ProtoMarshaler_ToAmino(message.moduleMetadata) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
