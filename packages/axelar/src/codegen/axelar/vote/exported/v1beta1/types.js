...
export function pollStateFromJSON(object) {
    switch (object) {
        case 0:
...
export function pollStateToJSON(object) {
    switch (object) {
...
export const PollMetadata = {
    ...
    toAmino(message) {
        ...
        obj.result = message.result ? Github_com_cosmos_codec_ProtoMarshaler_ToAmino(message.result) : undefined;
