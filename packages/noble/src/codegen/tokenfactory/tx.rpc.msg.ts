...
export class MsgClientImpl implements Msg {
  ...
  updateMasterMinter(request: MsgUpdateMasterMinter): Promise<MsgUpdateMasterMinterResponse> {
    ...
    const promise = this.rpc.request("noble.tokenfactory.Msg", "UpdateMasterMinter", data);
    return promise.then(data => MsgUpdateMasterMinterResponse.decode(new _m0.Reader(data)));
  }
  updatePauser(request: MsgUpdatePauser): Promise<MsgUpdatePauserResponse> {
    const data = MsgUpdatePauser.encode(request).finish();
    const promise = this.rpc.request("noble.tokenfactory.Msg", "UpdatePauser", data);
    return promise.then(data => MsgUpdatePauserResponse.decode(new _m0.Reader(data)));
  }
  updateBlacklister(request: MsgUpdateBlacklister): Promise<MsgUpdateBlacklisterResponse> {
    const data = MsgUpdateBlacklister.encode(request).finish();
    const promise = this.rpc.request("noble.tokenfactory.Msg", "UpdateBlacklister", data);
    return promise.then(data => MsgUpdateBlacklisterResponse.decode(new _m0.Reader(data)));
  }
  updateOwner(request: MsgUpdateOwner): Promise<MsgUpdateOwnerResponse> {
    const data = MsgUpdateOwner.encode(request).finish();
    const promise = this.rpc.request("noble.tokenfactory.Msg", "UpdateOwner", data);
  ...
  acceptOwner(request: MsgAcceptOwner): Promise<MsgAcceptOwnerResponse> {
    ...
    const promise = this.rpc.request("noble.tokenfactory.Msg", "AcceptOwner", data);
    return promise.then(data => MsgAcceptOwnerResponse.decode(new _m0.Reader(data)));
  }
  configureMinter(request: MsgConfigureMinter): Promise<MsgConfigureMinterResponse> {
    const data = MsgConfigureMinter.encode(request).finish();
    const promise = this.rpc.request("noble.tokenfactory.Msg", "ConfigureMinter", data);
    return promise.then(data => MsgConfigureMinterResponse.decode(new _m0.Reader(data)));
  }
  removeMinter(request: MsgRemoveMinter): Promise<MsgRemoveMinterResponse> {
    const data = MsgRemoveMinter.encode(request).finish();
    const promise = this.rpc.request("noble.tokenfactory.Msg", "RemoveMinter", data);
    return promise.then(data => MsgRemoveMinterResponse.decode(new _m0.Reader(data)));
  }
  mint(request: MsgMint): Promise<MsgMintResponse> {
    const data = MsgMint.encode(request).finish();
    const promise = this.rpc.request("noble.tokenfactory.Msg", "Mint", data);
    return promise.then(data => MsgMintResponse.decode(new _m0.Reader(data)));
  }
  burn(request: MsgBurn): Promise<MsgBurnResponse> {
    const data = MsgBurn.encode(request).finish();
    const promise = this.rpc.request("noble.tokenfactory.Msg", "Burn", data);
    return promise.then(data => MsgBurnResponse.decode(new _m0.Reader(data)));
  }
  blacklist(request: MsgBlacklist): Promise<MsgBlacklistResponse> {
    const data = MsgBlacklist.encode(request).finish();
    const promise = this.rpc.request("noble.tokenfactory.Msg", "Blacklist", data);
    return promise.then(data => MsgBlacklistResponse.decode(new _m0.Reader(data)));
  }
  unblacklist(request: MsgUnblacklist): Promise<MsgUnblacklistResponse> {
    const data = MsgUnblacklist.encode(request).finish();
    const promise = this.rpc.request("noble.tokenfactory.Msg", "Unblacklist", data);
    return promise.then(data => MsgUnblacklistResponse.decode(new _m0.Reader(data)));
  }
  pause(request: MsgPause): Promise<MsgPauseResponse> {
    const data = MsgPause.encode(request).finish();
    const promise = this.rpc.request("noble.tokenfactory.Msg", "Pause", data);
    return promise.then(data => MsgPauseResponse.decode(new _m0.Reader(data)));
  }
  unpause(request: MsgUnpause): Promise<MsgUnpauseResponse> {
    const data = MsgUnpause.encode(request).finish();
    const promise = this.rpc.request("noble.tokenfactory.Msg", "Unpause", data);
    return promise.then(data => MsgUnpauseResponse.decode(new _m0.Reader(data)));
  }
  configureMinterController(request: MsgConfigureMinterController): Promise<MsgConfigureMinterControllerResponse> {
    const data = MsgConfigureMinterController.encode(request).finish();
    const promise = this.rpc.request("noble.tokenfactory.Msg", "ConfigureMinterController", data);
    return promise.then(data => MsgConfigureMinterControllerResponse.decode(new _m0.Reader(data)));
  }
  removeMinterController(request: MsgRemoveMinterController): Promise<MsgRemoveMinterControllerResponse> {
    const data = MsgRemoveMinterController.encode(request).finish();
    const promise = this.rpc.request("noble.tokenfactory.Msg", "RemoveMinterController", data);
    return promise.then(data => MsgRemoveMinterControllerResponse.decode(new _m0.Reader(data)));
  }
}