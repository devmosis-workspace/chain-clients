...
export declare const cosmos_proto: {
    ...
    InterfaceDescriptor: {
        typeUrl: string;
        encode(message: _181.InterfaceDescriptor, writer?: import("..").BinaryWriter): import("..").BinaryWriter;
    ...
    ScalarDescriptor: {
        typeUrl: string;
        encode(message: _181.ScalarDescriptor, writer?: import("..").BinaryWriter): import("..").BinaryWriter;
