...
export const MsgInstantiateOracle = {
  ...
  fromJSON(object: any): MsgInstantiateOracle {
    return {
      ...
      contractCodeId: isSet(object.contractCodeId) ? BigInt(object.contractCodeId.toString()) : BigInt(0),
      transferChannelOnOracle: isSet(object.transferChannelOnOracle) ? String(object.transferChannelOnOracle) : ""
    };
  },
  ...
  toAmino(message: MsgInstantiateOracle): MsgInstantiateOracleAmino {
    ...
    obj.contract_code_id = message.contractCodeId ? message.contractCodeId.toString() : undefined;
    obj.transfer_channel_on_oracle = message.transferChannelOnOracle;
    return obj;
  },
