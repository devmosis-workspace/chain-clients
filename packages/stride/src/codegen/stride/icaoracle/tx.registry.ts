...
export const MessageComposer = {
  ...
  fromJSON: {
    addOracle(value: any) {
      return {
        typeUrl: "/stride.icaoracle.MsgAddOracle",
        value: MsgAddOracle.fromJSON(value)
      };
    },
    instantiateOracle(value: any) {
      return {
        typeUrl: "/stride.icaoracle.MsgInstantiateOracle",
        value: MsgInstantiateOracle.fromJSON(value)
      };
    },
    restoreOracleICA(value: any) {
      return {
        typeUrl: "/stride.icaoracle.MsgRestoreOracleICA",
        value: MsgRestoreOracleICA.fromJSON(value)
      };
    },
    toggleOracle(value: any) {
      return {
        typeUrl: "/stride.icaoracle.MsgToggleOracle",
        value: MsgToggleOracle.fromJSON(value)
      };
    },
    removeOracle(value: any) {
      return {
        typeUrl: "/stride.icaoracle.MsgRemoveOracle",
        value: MsgRemoveOracle.fromJSON(value)
      };
    }
  },
  fromPartial: {
