...
export const Oracle = {
  ...
  toAmino(message: Oracle): OracleAmino {
    ...
    obj.ica_address = message.icaAddress;
...
export const Metric = {
  ...
  fromJSON(object: any): Metric {
    return {
      ...
      destinationOracle: isSet(object.destinationOracle) ? String(object.destinationOracle) : "",
  ...
  fromAmino(object: MetricAmino): Metric {
    ...
    if (object.status !== undefined && object.status !== null) {
      message.status = metricStatusFromJSON(object.status);
    }
    return message;
  },
  toAmino(message: Metric): MetricAmino {
    ...
    obj.destination_oracle = message.destinationOracle;
...
export const RedemptionRateAttributes = {
  ...
  fromJSON(object: any): RedemptionRateAttributes {
    return {
      sttokenDenom: isSet(object.sttokenDenom) ? String(object.sttokenDenom) : ""
    };
  },
  ...
  toAmino(message: RedemptionRateAttributes): RedemptionRateAttributesAmino {
    const obj: any = {};
    obj.sttoken_denom = message.sttokenDenom;
    return obj;
  },
