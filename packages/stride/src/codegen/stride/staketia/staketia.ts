...
export const HostZone = {
  ...
  toAmino(message: HostZone): HostZoneAmino {
    ...
    obj.native_token_denom = message.nativeTokenDenom;
    obj.native_token_ibc_denom = message.nativeTokenIbcDenom;
    ...
    obj.redemption_address = message.redemptionAddress;
    obj.claim_address = message.claimAddress;
    obj.operator_address_on_stride = message.operatorAddressOnStride;
    obj.safe_address_on_stride = message.safeAddressOnStride;
    ...
    obj.delegated_balance = message.delegatedBalance;
    obj.unbonding_period_seconds = message.unbondingPeriodSeconds ? message.unbondingPeriodSeconds.toString() : undefined;
...
export const DelegationRecord = {
  ...
  fromAmino(object: DelegationRecordAmino): DelegationRecord {
    ...
    if (object.status !== undefined && object.status !== null) {
      message.status = delegationRecordStatusFromJSON(object.status);
    }
  ...
  toAmino(message: DelegationRecord): DelegationRecordAmino {
    ...
    obj.native_amount = message.nativeAmount;
...
export const UnbondingRecord = {
  ...
  fromAmino(object: UnbondingRecordAmino): UnbondingRecord {
    ...
    if (object.status !== undefined && object.status !== null) {
      message.status = unbondingRecordStatusFromJSON(object.status);
    }
  ...
  toAmino(message: UnbondingRecord): UnbondingRecordAmino {
    ...
    obj.native_amount = message.nativeAmount;
    obj.unbonding_completion_time_seconds = message.unbondingCompletionTimeSeconds ? message.unbondingCompletionTimeSeconds.toString() : undefined;
    obj.undelegation_tx_hash = message.undelegationTxHash;
    obj.unbonded_token_sweep_tx_hash = message.unbondedTokenSweepTxHash;
    return obj;
  },
...
export const RedemptionRecord = {
  ...
  toAmino(message: RedemptionRecord): RedemptionRecordAmino {
    const obj: any = {};
    obj.unbonding_record_id = message.unbondingRecordId ? message.unbondingRecordId.toString() : undefined;
