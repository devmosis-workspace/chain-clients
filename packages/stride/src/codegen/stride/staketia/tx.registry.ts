...
export const MessageComposer = {
  ...
  fromJSON: {
    ...
    confirmDelegation(value: any) {
      return {
        typeUrl: "/stride.staketia.MsgConfirmDelegation",
        value: MsgConfirmDelegation.fromJSON(value)
      };
    },
    confirmUndelegation(value: any) {
      return {
        typeUrl: "/stride.staketia.MsgConfirmUndelegation",
        value: MsgConfirmUndelegation.fromJSON(value)
      };
    },
    confirmUnbondedTokenSweep(value: any) {
      return {
        typeUrl: "/stride.staketia.MsgConfirmUnbondedTokenSweep",
        value: MsgConfirmUnbondedTokenSweep.fromJSON(value)
      };
    },
    adjustDelegatedBalance(value: any) {
      return {
        typeUrl: "/stride.staketia.MsgAdjustDelegatedBalance",
        value: MsgAdjustDelegatedBalance.fromJSON(value)
      };
    },
    ...
    refreshRedemptionRate(value: any) {
      return {
        typeUrl: "/stride.staketia.MsgRefreshRedemptionRate",
        value: MsgRefreshRedemptionRate.fromJSON(value)
      };
    },
    overwriteDelegationRecord(value: any) {
      return {
        typeUrl: "/stride.staketia.MsgOverwriteDelegationRecord",
        value: MsgOverwriteDelegationRecord.fromJSON(value)
      };
    },
    overwriteUnbondingRecord(value: any) {
      return {
        typeUrl: "/stride.staketia.MsgOverwriteUnbondingRecord",
        value: MsgOverwriteUnbondingRecord.fromJSON(value)
      };
    },
    overwriteRedemptionRecord(value: any) {
      return {
        typeUrl: "/stride.staketia.MsgOverwriteRedemptionRecord",
        value: MsgOverwriteRedemptionRecord.fromJSON(value)
      };
    },
    setOperatorAddress(value: any) {
      return {
        typeUrl: "/stride.staketia.MsgSetOperatorAddress",
        value: MsgSetOperatorAddress.fromJSON(value)
      };
    }
  },
  fromPartial: {
