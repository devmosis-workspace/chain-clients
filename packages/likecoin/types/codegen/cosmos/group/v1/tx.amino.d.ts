...
export declare const AminoConverter: {
    ...
    "/cosmos.group.v1.MsgSubmitProposal": {
        aminoType: string;
        toAmino: ({ groupPolicyAddress, proposers, metadata, messages, exec }: MsgSubmitProposal) => MsgSubmitProposalAminoType["value"];
        fromAmino: ({ group_policy_address, proposers, metadata, messages, exec }: MsgSubmitProposalAminoType["value"]) => MsgSubmitProposal;
    };
