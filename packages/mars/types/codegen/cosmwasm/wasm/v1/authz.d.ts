...
export declare const ContractAuthzLimitX_InterfaceDecoder: (input: BinaryReader | Uint8Array) => MaxCallsLimit | MaxFundsLimit | CombinedLimit | Any;
...
export declare const ContractAuthzFilterX_InterfaceDecoder: (input: BinaryReader | Uint8Array) => AllowAllMessagesFilter | AcceptedMessageKeysFilter | AcceptedMessagesFilter | Any;
export declare const ContractAuthzFilterX_FromAmino: (content: AnyAmino) => Any;
export declare const ContractAuthzFilterX_ToAmino: (content: Any) => AnyAmino;
