...
export const EvidenceParams = {
  ...
  encode(message: EvidenceParams, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    ...
    if (message.proofTrialPeriod !== BigInt(0)) {
  ...
  fromJSON(object: any): EvidenceParams {
    return {
      ...
      proofTrialPeriod: isSet(object.proofTrialPeriod) ? BigInt(object.proofTrialPeriod.toString()) : BigInt(0)
    };
  },
  fromPartial(object: Partial<EvidenceParams>): EvidenceParams {
    ...
    message.proofTrialPeriod = object.proofTrialPeriod !== undefined && object.proofTrialPeriod !== null ? BigInt(object.proofTrialPeriod.toString()) : BigInt(0);
    return message;
  },
  fromAmino(object: EvidenceParamsAmino): EvidenceParams {
    return {
      ...
      maxNum: object.max_num,
      proofTrialPeriod: BigInt(object.proof_trial_period)
    };
  },
  toAmino(message: EvidenceParams): EvidenceParamsAmino {
    ...
    obj.max_num = message.maxNum;
    obj.proof_trial_period = message.proofTrialPeriod ? message.proofTrialPeriod.toString() : undefined;
    return obj;
  },
