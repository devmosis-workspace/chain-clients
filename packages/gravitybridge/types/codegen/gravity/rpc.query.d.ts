...
export declare const createRPCQueryClient: ({ rpcEndpoint }: {
    ...
    gravity: {
        v1: {
            ...
            getLastObservedEthBlock(request: import("./v1/query").QueryLastObservedEthBlockRequest): Promise<import("./v1/query").QueryLastObservedEthBlockResponse>;
            getLastObservedEthNonce(request: import("./v1/query").QueryLastObservedEthNonceRequest): Promise<import("./v1/query").QueryLastObservedEthNonceResponse>;
            ...
            getPendingIbcAutoForwards(request: import("./v1/query").QueryPendingIbcAutoForwards): Promise<import("./v1/query").QueryPendingIbcAutoForwardsResponse>;
        };
    };
    cosmos: {
        auth: {
