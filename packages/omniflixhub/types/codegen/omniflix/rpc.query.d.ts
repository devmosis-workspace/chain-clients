...
export declare const createRPCQueryClient: ({ rpcEndpoint }: {
    ...
    OmniFlix: {
        ...
        onft: {
            v1beta1: {
                collection(request: import("./onft/v1beta1/query").QueryCollectionRequest): Promise<import("./onft/v1beta1/query").QueryCollectionResponse>;
                iBCCollection(request: import("./onft/v1beta1/query").QueryIBCCollectionRequest): Promise<import("./onft/v1beta1/query").QueryCollectionResponse>;
                denom(request: import("./onft/v1beta1/query").QueryDenomRequest): Promise<import("./onft/v1beta1/query").QueryDenomResponse>;
                iBCDenom(request: import("./onft/v1beta1/query").QueryIBCDenomRequest): Promise<import("./onft/v1beta1/query").QueryDenomResponse>;
                denoms(request: import("./onft/v1beta1/query").QueryDenomsRequest): Promise<import("./onft/v1beta1/query").QueryDenomsResponse>;
                oNFT(request: import("./onft/v1beta1/query").QueryONFTRequest): Promise<import("./onft/v1beta1/query").QueryONFTResponse>;
                iBCDenomONFT(request: import("./onft/v1beta1/query").QueryIBCDenomONFTRequest): Promise<import("./onft/v1beta1/query").QueryONFTResponse>;
                ownerONFTs(request: import("./onft/v1beta1/query").QueryOwnerONFTsRequest): Promise<import("./onft/v1beta1/query").QueryOwnerONFTsResponse>;
                ownerIBCDenomONFTs(request: import("./onft/v1beta1/query").QueryOwnerIBCDenomONFTsRequest): Promise<import("./onft/v1beta1/query").QueryOwnerONFTsResponse>;
                supply(request: import("./onft/v1beta1/query").QuerySupplyRequest): Promise<import("./onft/v1beta1/query").QuerySupplyResponse>;
                iBCDenomSupply(request: import("./onft/v1beta1/query").QueryIBCDenomSupplyRequest): Promise<import("./onft/v1beta1/query").QuerySupplyResponse>;
                params(request?: import("./onft/v1beta1/query").QueryParamsRequest): Promise<import("./onft/v1beta1/query").QueryParamsResponse>;
            };
        };
    };
    cosmos: {
