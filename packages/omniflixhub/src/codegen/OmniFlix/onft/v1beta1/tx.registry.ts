...
export const MessageComposer = {
  ...
  fromJSON: {
    ...
    updateDenom(value: any) {
      return {
        typeUrl: "/OmniFlix.onft.v1beta1.MsgUpdateDenom",
        value: MsgUpdateDenom.fromJSON(value)
      };
    },
    transferDenom(value: any) {
      return {
        typeUrl: "/OmniFlix.onft.v1beta1.MsgTransferDenom",
        value: MsgTransferDenom.fromJSON(value)
      };
    },
    purgeDenom(value: any) {
      return {
        typeUrl: "/OmniFlix.onft.v1beta1.MsgPurgeDenom",
        value: MsgPurgeDenom.fromJSON(value)
      };
    },
    mintONFT(value: any) {
      return {
        typeUrl: "/OmniFlix.onft.v1beta1.MsgMintONFT",
        value: MsgMintONFT.fromJSON(value)
      };
    },
    transferONFT(value: any) {
      return {
        typeUrl: "/OmniFlix.onft.v1beta1.MsgTransferONFT",
        value: MsgTransferONFT.fromJSON(value)
      };
    },
    burnONFT(value: any) {
      return {
        typeUrl: "/OmniFlix.onft.v1beta1.MsgBurnONFT",
        value: MsgBurnONFT.fromJSON(value)
      };
    },
