...
import { DistributionAuthorization, DistributionAuthorizationProtoMsg, DistributionAuthorizationSDKType } from "../../distribution/v1beta1/authz";
...
export interface Grant {
  authorization: (GenericAuthorization & SendAuthorization & DistributionAuthorization & StakeAuthorization & Any) | undefined;
  /**
...
export type GrantEncoded = Omit<Grant, "authorization"> & {
  authorization?: GenericAuthorizationProtoMsg | SendAuthorizationProtoMsg | DistributionAuthorizationProtoMsg | StakeAuthorizationProtoMsg | AnyProtoMsg | undefined;
};
/**
 * Grant gives permissions to execute
 * the provide method with expiration time.
...
export interface GrantSDKType {
  authorization: GenericAuthorizationSDKType | SendAuthorizationSDKType | DistributionAuthorizationSDKType | StakeAuthorizationSDKType | AnySDKType | undefined;
...
export const Authorization_InterfaceDecoder = (input: BinaryReader | Uint8Array): GenericAuthorization | SendAuthorization | DistributionAuthorization | StakeAuthorization | Any => {
  ...
  switch (data.typeUrl) {
    ...
    case "/cosmos.distribution.v1beta1.DistributionAuthorization":
      return DistributionAuthorization.decode(data.value);
...
export const Authorization_FromAmino = (content: AnyAmino) => {
  switch (content.type) {
    ...
    case "cosmos-sdk/DistributionAuthorization":
      return Any.fromPartial({
        typeUrl: "/cosmos.distribution.v1beta1.DistributionAuthorization",
        value: DistributionAuthorization.encode(DistributionAuthorization.fromPartial(DistributionAuthorization.fromAmino(content.value))).finish()
      });
  ...
  switch (content.typeUrl) {
    ...
    case "/cosmos.distribution.v1beta1.DistributionAuthorization":
      return {
        ...
        value: DistributionAuthorization.toAmino(DistributionAuthorization.decode(content.value))
      };
    case "/cosmos.staking.v1beta1.StakeAuthorization":
      return {
