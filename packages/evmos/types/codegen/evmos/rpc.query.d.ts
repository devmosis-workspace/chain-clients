...
export declare const createRPCQueryClient: ({ rpcEndpoint }: {
    ...
    evmos: {
        claims: {
            v1: {
                totalUnclaimed(request?: import("./claims/v1/query").QueryTotalUnclaimedRequest): Promise<import("./claims/v1/query").QueryTotalUnclaimedResponse>;
                params(request?: import("./claims/v1/query").QueryParamsRequest): Promise<import("./claims/v1/query").QueryParamsResponse>;
                claimsRecords(request?: import("./claims/v1/query").QueryClaimsRecordsRequest): Promise<import("./claims/v1/query").QueryClaimsRecordsResponse>;
                claimsRecord(request: import("./claims/v1/query").QueryClaimsRecordRequest): Promise<import("./claims/v1/query").QueryClaimsRecordResponse>;
            };
        };
        epochs: {
            v1: {
        ...
        incentives: {
            v1: {
                incentives(request?: import("./incentives/v1/query").QueryIncentivesRequest): Promise<import("./incentives/v1/query").QueryIncentivesResponse>;
                incentive(request: import("./incentives/v1/query").QueryIncentiveRequest): Promise<import("./incentives/v1/query").QueryIncentiveResponse>;
                gasMeters(request: import("./incentives/v1/query").QueryGasMetersRequest): Promise<import("./incentives/v1/query").QueryGasMetersResponse>;
                gasMeter(request: import("./incentives/v1/query").QueryGasMeterRequest): Promise<import("./incentives/v1/query").QueryGasMeterResponse>;
                allocationMeters(request?: import("./incentives/v1/query").QueryAllocationMetersRequest): Promise<import("./incentives/v1/query").QueryAllocationMetersResponse>;
                allocationMeter(request: import("./incentives/v1/query").QueryAllocationMeterRequest): Promise<import("./incentives/v1/query").QueryAllocationMeterResponse>;
                params(request?: import("./incentives/v1/query").QueryParamsRequest): Promise<import("./incentives/v1/query").QueryParamsResponse>;
            };
        };
        inflation: {
            v1: {
        ...
        recovery: {
            v1: {
                params(request?: import("./recovery/v1/query").QueryParamsRequest): Promise<import("./recovery/v1/query").QueryParamsResponse>;
            };
        };
        revenue: {
            v1: {
        ...
        vesting: {
            v1: {
                balances(request: import("./vesting/v1/query").QueryBalancesRequest): Promise<import("./vesting/v1/query").QueryBalancesResponse>;
            };
        };
    };
    cosmos: {
