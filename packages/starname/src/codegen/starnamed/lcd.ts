...
export const createLCDClient = async ({
  ...
  return {
    starnamed: {
      x: {
        configuration: {
          v1beta1: new (await import("../iov/configuration/v1beta1/query.lcd")).LCDQueryClient({
            requestClient
          })
        },
        escrow: {
          v1beta1: new (await import("../iov/escrow/v1beta1/query.lcd")).LCDQueryClient({
            requestClient
          })
        },
        starname: {
          v1beta1: new (await import("../iov/starname/v1beta1/query.lcd")).LCDQueryClient({
            requestClient
          })
        }
      }
