...
export const createRPCQueryClient = async ({
  ...
  return {
    starnamed: {
      x: {
        configuration: {
          v1beta1: (await import("../iov/configuration/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
        },
        escrow: {
          v1beta1: (await import("../iov/escrow/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
        },
        starname: {
          v1beta1: (await import("../iov/starname/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
        }
      }
    },
    cosmos: {
