...
export class LCDQueryClient {
  ...
  async channel(params: QueryChannelRequest): Promise<QueryChannelResponseSDKType> {
    const endpoint = `ibc/core/channel/v1beta1/channels/${params.channelId}/ports/${params.portId}`;
  ...
  async channels(params: QueryChannelsRequest = {
    ...
    const endpoint = `ibc/core/channel/v1beta1/channels`;
  ...
  async connectionChannels(params: QueryConnectionChannelsRequest): Promise<QueryConnectionChannelsResponseSDKType> {
    ...
    const endpoint = `ibc/core/channel/v1beta1/connections/${params.connection}/channels`;
  ...
  async channelClientState(params: QueryChannelClientStateRequest): Promise<QueryChannelClientStateResponseSDKType> {
    const endpoint = `ibc/core/channel/v1beta1/channels/${params.channelId}/ports/${params.portId}/client_state`;
  ...
  async channelConsensusState(params: QueryChannelConsensusStateRequest): Promise<QueryChannelConsensusStateResponseSDKType> {
    const endpoint = `ibc/core/channel/v1beta1/channels/${params.channelId}/ports/${params.portId}/consensus_state/revision/${params.revisionNumber}/height/${params.revisionHeight}`;
  ...
  async packetCommitment(params: QueryPacketCommitmentRequest): Promise<QueryPacketCommitmentResponseSDKType> {
    const endpoint = `ibc/core/channel/v1beta1/channels/${params.channelId}/ports/${params.portId}/packet_commitments/${params.sequence}`;
  ...
  async packetCommitments(params: QueryPacketCommitmentsRequest): Promise<QueryPacketCommitmentsResponseSDKType> {
    ...
    const endpoint = `ibc/core/channel/v1beta1/channels/${params.channelId}/ports/${params.portId}/packet_commitments`;
  ...
  async packetReceipt(params: QueryPacketReceiptRequest): Promise<QueryPacketReceiptResponseSDKType> {
    const endpoint = `ibc/core/channel/v1beta1/channels/${params.channelId}/ports/${params.portId}/packet_receipts/${params.sequence}`;
  ...
  async packetAcknowledgement(params: QueryPacketAcknowledgementRequest): Promise<QueryPacketAcknowledgementResponseSDKType> {
    const endpoint = `ibc/core/channel/v1beta1/channels/${params.channelId}/ports/${params.portId}/packet_acks/${params.sequence}`;
  ...
  async packetAcknowledgements(params: QueryPacketAcknowledgementsRequest): Promise<QueryPacketAcknowledgementsResponseSDKType> {
    ...
    const endpoint = `ibc/core/channel/v1beta1/channels/${params.channelId}/ports/${params.portId}/packet_acknowledgements`;
  ...
  async unreceivedPackets(params: QueryUnreceivedPacketsRequest): Promise<QueryUnreceivedPacketsResponseSDKType> {
    const endpoint = `ibc/core/channel/v1beta1/channels/${params.channelId}/ports/${params.portId}/packet_commitments/${params.packetCommitmentSequences}/unreceived_packets`;
  ...
  async unreceivedAcks(params: QueryUnreceivedAcksRequest): Promise<QueryUnreceivedAcksResponseSDKType> {
    const endpoint = `ibc/core/channel/v1beta1/channels/${params.channelId}/ports/${params.portId}/packet_commitments/${params.packetAckSequences}/unreceived_acks`;
  ...
  async nextSequenceReceive(params: QueryNextSequenceReceiveRequest): Promise<QueryNextSequenceReceiveResponseSDKType> {
    const endpoint = `ibc/core/channel/v1beta1/channels/${params.channelId}/ports/${params.portId}/next_sequence`;
