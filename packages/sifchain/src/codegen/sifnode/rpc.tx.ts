...
export const createRPCMsgClient = async ({
  ...
  sifnode: {
    admin: {
      v1: new (await import("./admin/v1/tx.rpc.msg")).MsgClientImpl(rpc)
    },
    clp: {
      v1: new (await import("./clp/v1/tx.rpc.msg")).MsgClientImpl(rpc)
    },
    dispensation: {
      v1: new (await import("./dispensation/v1/tx.rpc.msg")).MsgClientImpl(rpc)
    },
    ethbridge: {
      v1: new (await import("./ethbridge/v1/tx.rpc.msg")).MsgClientImpl(rpc)
    },
    margin: {
      v1: new (await import("./margin/v1/tx.rpc.msg")).MsgClientImpl(rpc)
    },
    tokenregistry: {
      v1: new (await import("./tokenregistry/v1/tx.rpc.msg")).MsgClientImpl(rpc)
    }
  },
  cosmos: {
    authz: {
