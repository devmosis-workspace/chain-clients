...
export const createLCDClient = async ({
  ...
  return {
    sifnode: {
      clp: {
        v1: new (await import("./clp/v1/querier.lcd")).LCDQueryClient({
          requestClient
        })
      },
      epochs: {
      ...
      margin: {
        v1: new (await import("./margin/v1/query.lcd")).LCDQueryClient({
          requestClient
        })
      },
      tokenregistry: {
        v1: new (await import("./tokenregistry/v1/query.lcd")).LCDQueryClient({
          requestClient
        })
      }
    },
